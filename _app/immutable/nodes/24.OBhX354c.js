import"../chunks/DsnmJJEf.js";import"../chunks/sDYslN56.js";import{p as Ma,aH as fe,aI as zs,a as Ra,g as a,s as e,c as i,a4 as q,ao as _,r as n,u as c,n as h,f as H,aK as ya,t as W,aL as en,aM as an,d as tn}from"../chunks/CZzIV55D.js";import{a as l,f as p,t as Wa,e as sn,c as Es}from"../chunks/UcDFViGA.js";import{h as t}from"../chunks/D-VbVIMD.js";import{i as Aa}from"../chunks/Cip6YPdY.js";import{D as nn,d as j}from"../chunks/CpJ4BgJm.js";import{M as rn,a as s,_ as B}from"../chunks/BtH6GhOB.js";import{s as A}from"../chunks/3qRHltW6.js";import{i as y}from"../chunks/BJjYSnFD.js";import{e as ie,i as re}from"../chunks/CTa6ybkt.js";import{r as ht,s as x}from"../chunks/DXlEpTQd.js";import{s as ga}from"../chunks/DvReYul2.js";import{e as wa}from"../chunks/BWhIhoIv.js";import{b as pt}from"../chunks/rWj9Gqlu.js";import{o as on}from"../chunks/DY9qbGRG.js";import{A as ln}from"../chunks/Cw6tFTSG.js";import{R as cn}from"../chunks/BkkycDmh.js";var hn=p('<span class="plus svelte-11fkcz8">+</span>'),pn=p("<sup></sup>"),vn=p('<span class="pow svelte-11fkcz8">x<!></span>'),dn=p('<!> <span class="cell svelte-11fkcz8"><input type="number" min="0" step="1" class="svelte-11fkcz8"/> <!></span>',1),un=p('<span class="plus svelte-11fkcz8">+</span>'),mn=p("<sup></sup>"),fn=p('<span class="pow svelte-11fkcz8">x<!></span>'),bn=p('<!> <span class="cell svelte-11fkcz8"><input type="number" min="0" step="1" class="svelte-11fkcz8"/> <!></span>',1),yn=p('<span class="term svelte-11fkcz8">0</span>'),gn=p('<span class="plus svelte-11fkcz8">+</span>'),wn=p("<sup> </sup>"),xn=p("x<!>",1),kn=p("<!> <span> <!></span>",1),qn=p('<span class="term svelte-11fkcz8">0</span>'),_n=p('<span class="plus svelte-11fkcz8">+</span>'),Tn=p('<b class="wrap svelte-11fkcz8"> </b>'),En=p("<sup> </sup>"),zn=p("x<!>",1),Ln=p('<!> <span class="term svelte-11fkcz8"><!> <!><!><!></span>',1),Mn=p('<span class="term final svelte-11fkcz8">0</span>'),Rn=p('<span class="plus svelte-11fkcz8">+</span>'),An=p("<sup> </sup>"),Wn=p("x<!>",1),Sn=p('<!> <span class="term final svelte-11fkcz8"> <!></span>',1),$n=p('<div class="ringmul tc mx-a my20 p10 rx10 svelte-11fkcz8"><div class="fw al-ct j-ct g5 my5"><span class="lbl svelte-11fkcz8">a(x)</span> <span class="plus svelte-11fkcz8">=</span> <!></div> <div class="fw al-ct j-ct g5 my5"><span class="lbl svelte-11fkcz8">b(x)</span> <span class="plus svelte-11fkcz8">=</span> <!></div> <div class="fw al-ct j-ct g5 my5"><span class="lbl svelte-11fkcz8">a·b</span> <span class="plus svelte-11fkcz8">=</span> <!> <!></div> <div class="fw al-ct j-ct g5 my5"><span class="lbl svelte-11fkcz8">x<sup></sup> ≡ −1</span> <span class="plus svelte-11fkcz8">≡</span> <!> <!></div> <div class="fw al-ct j-ct g5 my5"><span class="lbl svelte-11fkcz8"></span> <span class="plus svelte-11fkcz8">≡</span> <!> <!></div> <div class="note mt10 svelte-11fkcz8">every product in <b>R<sub></sub></b> </div></div>'),Kn=p("<button> </button>"),Pn=p('<span class="pcell svelte-1x9pnmt"> </span>'),Cn=p('<div class="prow svelte-1x9pnmt"><span> </span> <span class="pname svelte-1x9pnmt"> </span> <!></div>'),jn=sn('<rect width="26"></rect><text y="206" text-anchor="middle"> </text>',1),In=p(`<div class="hint tc mt5 svelte-1x9pnmt">no noise at all: decryption is perfect, but b = a·s exactly, so
            Eve computes b·a<sup>−1</sup> and has the secret key</div>`),Fn=p(`<div class="pg mx-a my20 p10 rx10 svelte-1x9pnmt"><div class="f al-ct j-ct fw g10 mb10"><label class="svelte-1x9pnmt">error size η = <b> </b> <input type="range" min="0" max="6" class="svelte-1x9pnmt"/></label> <button class="svelte-1x9pnmt">new keys</button> <button class="svelte-1x9pnmt">re-encrypt</button></div> <div class="tc my5"><span class="cap svelte-1x9pnmt">message (click bits to flip):</span> <!></div> <div class="polys svelte-1x9pnmt"></div> <div class="tc"><svg width="430" height="216" font-family="monospace" font-size="10" class="svelte-1x9pnmt"><rect x="44" fill="rgba(34, 170, 255, 0.10)"></rect><line x1="44" stroke="#999"></line><line x1="44" stroke="#e67" stroke-dasharray="4 3"></line><line x1="44" stroke="#e67" stroke-dasharray="4 3"></line><text x="40" text-anchor="end">+48</text><text x="40" text-anchor="end" fill="#e67">+q/4</text><text x="40" text-anchor="end">0</text><text x="40" text-anchor="end" fill="#e67">−q/4</text><text x="40" text-anchor="end">−48</text><!></svg> <div class="cap svelte-1x9pnmt">coefficients of v − u·s (centered mod 97), decoded bits below</div></div> <div><!></div> <!> <div class="note tc mt10 svelte-1x9pnmt">Eve only ever sees a, b, u, v. Each is indistinguishable from uniform
        random numbers mod 97; the secret s and all the error polynomials
        never leave home.</div></div>`);function Nn(Sa,$a){Ma($a,!1);const Te=q(),Ee=q(),oe=q(),I=q(),be=q(),Ne=q(),le=97,ce=le/4;let $=q(1),M=q([1,0,1,1,0,0,1,0]),ze=q(0),Le=q(0);const ye=r=>(r%le+le)%le,Oe=r=>ye(r)>le/2?ye(r)-le:ye(r),aa=(r,v)=>r+Math.floor(Math.random()*(v-r+1)),Me=r=>Array.from({length:8},()=>aa(-r,r));function Re(r,v){const m=new Array(8).fill(0);for(let b=0;b<8;b++)for(let E=0;E<8;E++)m[(b+E)%8]+=(b+E<8?1:-1)*r[b]*v[E];return m.map(ye)}const Ae=(r,v)=>r.map((m,b)=>ye(m+v[b]));let G=q([]),he=q([]),ta=q([]),J=q([]),ge=q([]),sa=q([]),Be=q([]);const z=r=>100-r*(88/48),na=r=>48+46*r;fe(()=>(a(ze),a($),a(G),a(he),a(ta)),()=>{a(ze),a($),_(G,Array.from({length:8},()=>aa(0,96))),_(he,Me(Math.max(1,+a($)))),_(ta,Me(+a($))),_(J,Ae(Re(a(G),a(he)),a(ta)))}),fe(()=>(a(Le),a(J),a($)),()=>{a(Le),a(J),_(ge,Me(Math.max(1,+a($)))),_(sa,Me(+a($))),_(Be,Me(+a($)))}),fe(()=>(a(G),a(ge),a(sa)),()=>{_(Te,Ae(Re(a(G),a(ge)),a(sa)))}),fe(()=>(a(J),a(ge),a(Be),a(M)),()=>{_(Ee,Ae(Ae(Re(a(J),a(ge)),a(Be)),a(M).map(r=>48*r)))}),fe(()=>(a(Ee),a(Te),a(he)),()=>{var r,v;_(oe,(r=a(Ee),v=Re(a(Te),a(he)),r.map((m,b)=>ye(m-v[b]))).map(Oe))}),fe(()=>a(oe),()=>{_(I,a(oe).map(r=>Math.abs(r)>ce?1:0))}),fe(()=>(a(I),a(M)),()=>{_(be,a(I).filter((r,v)=>r!==a(M)[v]).length)}),fe(()=>(a(oe),a(M)),()=>{_(Ne,Math.max(...a(oe).map((r,v)=>Math.abs(Oe(r-48*a(M)[v])))))}),zs(),Aa();var He=Fn(),De=i(He),Ye=i(De),ia=e(i(Ye)),ra=i(ia,!0);n(ia);var oa=e(ia,2);ht(oa),n(Ye);var la=e(Ye,2),xa=e(la,2);n(De);var Ze=e(De,2),ka=e(i(Ze),2);ie(ka,1,()=>a(M),re,(r,v,m)=>{var b=Kn();let E;var F=i(b,!0);n(b),W(()=>{E=ga(b,1,"bit svelte-1x9pnmt",null,E,{on:a(v)===1}),A(F,a(v))}),wa("click",b,()=>ya(M,a(M)[m]=1-a(M)[m])),l(r,b)}),n(Ze);var ca=e(Ze,2);ie(ca,5,()=>[["pub","public","a",a(G)],["pub","public","b",a(J)],["sec","secret","s",a(he)],["ct","sent","u",a(Te)],["ct","sent","v",a(Ee)]],re,(r,v)=>{var m=en(()=>an(a(v),4)),b=Cn(),E=i(b),F=i(E,!0);n(E);var Q=e(E,2),we=i(Q);n(Q);var je=e(Q,2);ie(je,1,()=>a(m)[3],re,(xe,pe)=>{var ke=Pn(),Ge=i(ke,!0);n(ke),W(()=>A(Ge,a(pe))),l(xe,ke)}),n(b),W(()=>{ga(E,1,`tag ${a(m)[0]??""}`,"svelte-1x9pnmt"),A(F,a(m)[1]),A(we,`${a(m)[2]??""} =`)}),l(r,b)}),n(ca);var We=e(ca,2),ha=i(We),Se=i(ha);x(Se,"width",352);var $e=e(Se);x($e,"x2",396);var Ke=e($e);x(Ke,"x2",396);var Pe=e(Ke);x(Pe,"x2",396);var pa=e(Pe),qa=e(pa),Qe=e(qa),va=e(Qe),da=e(va),_a=e(da);ie(_a,1,()=>a(oe),re,(r,v,m)=>{var b=jn(),E=H(b),F=e(E),Q=i(F,!0);n(F),W((we,je,xe,pe)=>{x(E,"x",we),x(E,"y",je),x(E,"height",xe),x(E,"fill",(a(I),a(M),c(()=>a(I)[m]===a(M)[m]?"#2af":"#e44"))),x(F,"x",pe),x(F,"fill",(a(I),a(M),c(()=>a(I)[m]===a(M)[m]?"#555":"#e44"))),x(F,"font-weight",(a(I),a(M),c(()=>a(I)[m]===a(M)[m]?"normal":"bold"))),A(Q,(a(I),c(()=>a(I)[m])))},[()=>c(()=>na(m)),()=>(a(v),c(()=>Math.min(z(0),z(a(v))))),()=>(a(v),c(()=>Math.abs(z(a(v))-z(0))||1)),()=>c(()=>na(m)+13)]),l(r,b)}),n(ha),h(2),n(We);var Ce=e(We,2);let ua;var Ka=i(Ce),Ta=r=>{var v=Wa();W(()=>A(v,`✓ all 8 bits decoded correctly · largest noise |w| = ${a(Ne)??""} of
            the 24.25 allowed`)),l(r,v)},ma=r=>{var v=Wa();W(()=>A(v,`✗ ${a(be)??""} of 8 bits flipped · largest noise |w| = ${a(Ne)??""} blew
            past the limit of 24.25`)),l(r,v)};y(Ka,r=>{a(be)===0?r(Ta):r(ma,!1)}),n(Ce);var Ea=e(Ce,2),za=r=>{var v=In();l(r,v)};y(Ea,r=>{+a($)==0&&r(za)}),h(2),n(He),W((r,v,m,b,E,F,Q,we,je,xe,pe,ke,Ge)=>{A(ra,a($)),x(Se,"y",r),x(Se,"height",v),x($e,"y1",m),x($e,"y2",b),x(Ke,"y1",E),x(Ke,"y2",F),x(Pe,"y1",Q),x(Pe,"y2",we),x(pa,"y",je),x(qa,"y",xe),x(Qe,"y",pe),x(va,"y",ke),x(da,"y",Ge),ua=ga(Ce,1,"verdict tc mt10 svelte-1x9pnmt",null,ua,{bad:a(be)>0})},[()=>c(()=>z(ce)),()=>c(()=>z(-24.25)-z(ce)),()=>c(()=>z(0)),()=>c(()=>z(0)),()=>c(()=>z(ce)),()=>c(()=>z(ce)),()=>c(()=>z(-24.25)),()=>c(()=>z(-24.25)),()=>c(()=>z(48)+3),()=>c(()=>z(ce)+3),()=>c(()=>z(0)+3),()=>c(()=>z(-24.25)+3),()=>c(()=>z(-48)+3)]),pt(oa,()=>a($),r=>_($,r)),wa("click",la,()=>_(ze,a(ze)+1)),wa("click",xa,()=>_(Le,a(Le)+1)),l(Sa,He),Ra()}var On=p(`<p class="svelte-kugc17">Your browser just opened a fresh TLS connection to a test
                server, and the key agreement used <b> </b>. That is
                ML-KEM, the lattice scheme this article builds, hybridised with
                the classical elliptic-curve exchange.</p>`),Bn=p(`<p class="svelte-kugc17">Your browser just opened a fresh TLS connection to a test
                server, and the key agreement used <b> </b>. That is
                classical only, no ML-KEM. A recording of that handshake could
                be unwrapped by a future quantum computer.</p>`),Hn=p(`<p class="svelte-kugc17">The request to the test server did not make it (an ad blocker,
                a strict privacy mode, or being offline will do that), so there
                is nothing to report.</p>`),Dn=p('<div><span class="k svelte-kugc17"> </span> </div>'),Yn=p('<div class="trace my10 py5 px10 rx5 svelte-kugc17"></div>'),Zn=p(`<!> <!> <p class="note svelte-kugc17">via pq.cloudflareresearch.com/cdn-cgi/trace, which echoes back the
            key exchange it negotiated with you. This tests your browser, not
            this site.</p>`,1),Qn=p("<div><!></div>"),Gn=p(`<!> <!> Cast: <ul><li>Alice (wants to receive secrets)</li> <li>Bob (wants to send her one)</li> <li>Eve (reads everything in transit)</li> <li>a large quantum computer (arrival date unknown)</li></ul> <!> <p>Nearly every secret on the internet is guarded by one of two locks: RSA,
...
\\end{aligned}
`);var Q=e(F,2),we=e(i(Q));t(we,()=>s`4x^4 \\equiv -4`);var je=e(we,2);t(je,()=>s`x^3`),h(),n(Q);var xe=e(Q,4);(function(fa,st){Ma(st,!1);let R=q([1,2,3,4]),S=q([2,1,0,0]);const Je=f=>(f%17+17)%17,Ve=f=>{const o=Math.trunc(Number(f));return Number.isFinite(o)?Je(o):0};let Ie=q([]),V=q([]),Xe=q([]);const ve=f=>f.map((o,d)=>({v:o,i:d})).filter(o=>o.v!==0);fe(()=>(a(R),a(S)),()=>{const f=a(R).map(Ve),o=a(S).map(Ve),d=new Array(7).fill(0);for(let g=0;g<4;g++)for(let T=0;T<4;T++)d[g+T]+=f[g]*o[T];_(Ie,d),_(Xe,d.slice(0,4).map((g,T)=>({lo:g,hi:d[T+4]||0,i:T})).filter(g=>g.lo!==0||g.hi!==0)),_(V,d.slice(0,4).map((g,T)=>Je(g-(d[T+4]||0))))}),zs(),Aa();var Fe=$n(),de=i(Fe),X=e(i(de),4);ie(X,1,()=>a(R),re,(f,o,d)=>{var g=dn(),T=H(g),ue=u=>{var w=hn();l(u,w)};y(T,u=>{d>0&&u(ue)});var K=e(T,2),L=i(K);ht(L),x(L,"max",16);var se=e(L,2),ne=u=>{var w=vn(),O=e(i(w)),me=P=>{var C=pn();C.textContent=d,l(P,C)};y(O,P=>{d>1&&P(me)}),n(w),l(u,w)};y(se,u=>{d>0&&u(ne)}),n(K),pt(L,()=>a(R)[d],u=>ya(R,a(R)[d]=u)),wa("change",L,()=>ya(R,a(R)[d]=Ve(a(R)[d]))),l(f,g)}),n(de);var qe=e(de,2),nt=e(i(qe),4);ie(nt,1,()=>a(S),re,(f,o,d)=>{var g=bn(),T=H(g),ue=u=>{var w=un();l(u,w)};y(T,u=>{d>0&&u(ue)});var K=e(T,2),L=i(K);ht(L),x(L,"max",16);var se=e(L,2),ne=u=>{var w=fn(),O=e(i(w)),me=P=>{var C=mn();C.textContent=d,l(P,C)};y(O,P=>{d>1&&P(me)}),n(w),l(u,w)};y(se,u=>{d>0&&u(ne)}),n(K),pt(L,()=>a(S)[d],u=>ya(S,a(S)[d]=u)),wa("change",L,()=>ya(S,a(S)[d]=Ve(a(S)[d]))),l(f,g)}),n(qe);var ba=e(qe,2),La=e(i(ba),4),D=f=>{var o=yn();l(f,o)};y(La,f=>{a(Ie),c(()=>ve(a(Ie)).length===0)&&f(D)});var Y=e(La,2);ie(Y,1,()=>(a(Ie),c(()=>ve(a(Ie)))),re,(f,o,d)=>{var g=kn(),T=H(g),ue=w=>{var O=gn();l(w,O)};y(T,w=>{d>0&&w(ue)});var K=e(T,2);let L;var se=i(K,!0),ne=e(se),u=w=>{var O=xn(),me=e(H(O)),P=C=>{var k=wn(),N=i(k,!0);n(k),W(()=>A(N,(a(o),c(()=>a(o).i)))),l(C,k)};y(me,C=>{a(o),c(()=>a(o).i>1)&&C(P)}),l(w,O)};y(ne,w=>{a(o),c(()=>a(o).i>0)&&w(u)}),n(K),W(()=>{L=ga(K,1,"term svelte-11fkcz8",null,L,{wrap:a(o).i>=4}),A(se,(a(o),c(()=>a(o).v)))}),l(f,g)}),n(ba);var U=e(ba,2),ee=i(U);e(i(ee)).textContent="4",h(),n(ee);var _e=e(ee,4),Z=f=>{var o=qn();l(f,o)};y(_e,f=>{a(Xe),c(()=>a(Xe).length===0)&&f(Z)});var ae=e(_e,2);ie(ae,1,()=>a(Xe),re,(f,o,d)=>{var g=Ln(),T=H(g),ue=k=>{var N=_n();l(k,N)};y(T,k=>{d>0&&k(ue)});var K=e(T,2),L=i(K),se=k=>{var N=Wa("(");l(k,N)};y(L,k=>{a(o),c(()=>a(o).hi&&a(o).i>0)&&k(se)});var ne=e(L,1,!0),u=e(ne),w=k=>{var N=Tn(),ot=i(N);n(N),W(()=>A(ot,`−${a(o),c(()=>a(o).hi)??""}`)),l(k,N)};y(u,k=>{a(o),c(()=>a(o).hi)&&k(w)});var O=e(u),me=k=>{var N=Wa(")");l(k,N)};y(O,k=>{a(o),c(()=>a(o).hi&&a(o).i>0)&&k(me)});var P=e(O),C=k=>{var N=zn(),ot=e(H(N)),Xs=lt=>{var ct=En(),Us=i(ct,!0);n(ct),W(()=>A(Us,(a(o),c(()=>a(o).i)))),l(lt,ct)};y(ot,lt=>{a(o),c(()=>a(o).i>1)&&lt(Xs)}),l(k,N)};y(P,k=>{a(o),c(()=>a(o).i>0)&&k(C)}),n(K),W(()=>A(ne,(a(o),c(()=>a(o).lo)))),l(f,g)}),n(U);var te=e(U,2),Ue=i(te);Ue.textContent="mod 17";var ea=e(Ue,4),it=f=>{var o=Mn();l(f,o)};y(ea,f=>{a(V),c(()=>ve(a(V)).length===0)&&f(it)});var Vs=e(ea,2);ie(Vs,1,()=>(a(V),c(()=>ve(a(V)))),re,(f,o,d)=>{var g=Sn(),T=H(g),ue=u=>{var w=Rn();l(u,w)};y(T,u=>{d>0&&u(ue)});var K=e(T,2),L=i(K,!0),se=e(L),ne=u=>{var w=Wn(),O=e(H(w)),me=P=>{var C=An(),k=i(C,!0);n(C),W(()=>A(k,(a(o),c(()=>a(o).i)))),l(P,C)};y(O,P=>{a(o),c(()=>a(o).i>1)&&P(me)}),l(u,w)};y(se,u=>{a(o),c(()=>a(o).i>0)&&u(ne)}),n(K),W(()=>A(L,(a(o),c(()=>a(o).v)))),l(f,g)}),n(te);var Ts=e(te,2),rt=e(i(Ts));e(i(rt)).textContent="17",n(rt),e(rt).nodeValue=` with n = 4: long
        multiplication, the tinted overflow terms fold back with a sign flip,
        coefficients wrap mod 17`,n(Ts),n(Fe),l(fa,Fe),Ra()})(xe,{});var pe=e(xe,2),ke=e(i(pe));t(ke,()=>s`R_q = \\mathbb{Z}_q[x]/(x^n + 1)`);var Ge=e(ke,2);t(Ge,()=>s`n`);var Ls=e(Ge,2);t(Ls,()=>s`q`),h(5),n(pe);var Pa=e(pe,2),vt=e(i(Pa));t(vt,()=>s`\\mathbb{Z}_q`);var dt=e(vt,2);t(dt,()=>s`\\mathbb{Z}_q[x]`);var ut=e(dt,2);t(ut,()=>s`x`);var mt=e(ut,2);t(mt,()=>s`(x^n + 1)`);var ft=e(mt,2);t(ft,()=>s`x^n + 1`);var Ms=e(ft,2);t(Ms,()=>s`x^n \\equiv -1`),h(),n(Pa);var Ca=e(Pa,2),bt=e(i(Ca));t(bt,()=>s`n`);var yt=e(bt,2);t(yt,()=>s`n`);var gt=e(yt,2);t(gt,()=>s`n^2`);var wt=e(gt,2);t(wt,()=>s`\\mathcal{O}(n \\log n)`);var Rs=e(wt,2);t(Rs,()=>s`\\mathcal{O}(n^2)`),h(),n(Ca);var ja=e(Ca,4),xt=e(i(ja));t(xt,()=>s`s`);var kt=e(xt,4);t(kt,()=>s`\\{-1, 0,
...
`);var Ja=e(is,2),rs=e(i(Ja));t(rs,()=>s`w`);var os=e(rs,2);t(os,()=>s`q/4 \\approx
    ...
    \\cdot r`);var ps=e(hs,2);t(ps,()=>s`n`);var vs=e(ps,2);t(vs,()=>s`\\eta`);var ds=e(vs,2);t(ds,()=>s`n \\eta^2`);var us=e(ds,2);t(us,()=>s`\\eta`);var Hs=e(us,2);t(Hs,()=>s`2^{160}`),h(),n(Va);var Xa=e(Va,4),ms=e(i(Xa));t(ms,()=>s`n = 8`);var fs=e(ms,2);t(fs,()=>s`q = 97`);var bs=e(fs,2);t(bs,()=>s`\\lfloor q/2 \\rfloor = 48`);var ys=e(bs,2);t(ys,()=>s`q/4
