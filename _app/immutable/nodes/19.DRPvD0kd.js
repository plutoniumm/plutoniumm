import"../chunks/DsnmJJEf.js";import"../chunks/69_IOA4Y.js";import{p as We,m as G,a as Se,c as B,s as e,ar as Me,r as h,M as H,u as P,a7 as Be,g as R,f as E,n as Ce,d as Ie}from"../chunks/B2m1v2r5.js";import{a as C,f as K,e as X}from"../chunks/jMVSJ8sL.js";import{h as a}from"../chunks/Dinoy2hm.js";import{i as Ae}from"../chunks/DfRH6yYd.js";import{D as Re,_ as O,a as t,d as V}from"../chunks/DiDFwN8_.js";import{o as Ne}from"../chunks/Dg3jdXm7.js";import{s as U}from"../chunks/U_RTbSeY.js";import{e as J,i as L}from"../chunks/yeFf2kLj.js";import{s as I}from"../chunks/i3WTgkrM.js";import{p as Q}from"../chunks/CLlFx2vb.js";import{M as ke,R as ze}from"../chunks/DUMmpYWJ.js";import{A as Oe}from"../chunks/Do23EQ4p.js";var Ue=X('<tspan id="digit" y="25"> </tspan>'),De=X('<tspan id="bar" y="45">―</tspan>'),Ge=X('<tspan id="base" y="65"> <tspan baseline-shift="super" font-size="8"> </tspan></tspan> <tspan id="power" y="60"> </tspan>',1),He=K('<p class="w-100 tc"><svg height="80" font-family="sans-serif" font-weight="300" font-size="24" transform="scale(1.25)"><text x="10" y="20"></text><text x="10" y="45"></text><text x="10" y="70" font-size="12"></text></svg></p>');function l(D,u){We(u,!1);let r=Q(u,"top",24,()=>[]),b=Q(u,"base",8),p=Q(u,"base_str",12,"?"),w=Be(1),W=Be(30);p()==="?"&&b()!==void 0&&p(b().toString()),Ne(()=>{r().includes(".")&&Me(w,r().length-r().indexOf(".")),b()<=9&&b()>=2&&b()%1===0&&Me(W,24)}),Ae();var g=He(),_=B(g),y=B(_);J(y,5,r,L,(v,T,s)=>{var i=Ue();I(i,"x",15+s*30);var o=B(i,!0);h(i),G(()=>U(o,R(T))),C(v,i)}),h(y);var x=e(y);J(x,5,r,L,(v,T,s,i)=>{var o=De();I(o,"x",10+s*30),C(v,o)}),h(x);var S=e(x);J(S,5,r,L,(v,T,s,i)=>{var o=Ge(),f=E(o);I(f,"x",10+s*30);var A=B(f),j=e(A),N=B(j,!0);h(j),h(f);var $=e(f,2),k=B($,!0);h($),G(()=>{U(A,`(${p()??""})`),U(N,(H(r()),P(()=>r().length-s))),I($,"x",R(W)+s*30),U(k,(H(r()),R(w),P(()=>r().length-s-R(w))))}),C(v,o)}),h(S),h(_),h(g),G(()=>I(_,"width",(H(r()),P(()=>15+r().length*30)))),C(D,g),Se()}var Pe=K(`Consider the number first in base 10: 31.125. We will follow the process to
...
\\begin{align*}
  ...
  8 \\div 7 &= 1\\ &r\\ 1\\\\
\\end{align*}
`);var s=e(T,2);a(s,()=>b(420,7));var i=e(s,2);l(i,{top:[1,1,4,0],base:7});var o=e(i,2);a(o,()=>t`b`);var f=e(o,2);a(f,()=>t`b-1`);var A=e(f,4);a(A,()=>t`b`);var j=e(A,2);a(j,()=>t`b-1`);var N=e(j,2);a(N,()=>t`|b|-1`);var $=e(N,2);a($,()=>t`b`);var k=e($,2);l(k,{top:[1,1,1,0],base:-2});var Y=e(k,2);a(Y,()=>r([1,1,1,0],-2,"= -6"));var Z=e(Y,2);a(Z,()=>t`\\frac1n`);var ee=e(Z,2);Oe(ee,{title:"Base ½ example",children:(d,q)=>{Ce();var z=Pe(),M=e(E(z));a(M,()=>O`
  \\begin{align*}
    31 \\div 2 &= 15\\ &r\\ 1\\\\
    15 \\div 2 &= 7\\ &r\\ 1\\\\
    7 \\div 2 &= 3\\ &r\\ 1\\\\
