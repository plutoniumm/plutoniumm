import{$ as e,A as M,E as G,K as H,L,M as K,N as Z,Q as J,R as N,T as P,V as Q,Z as C,a as D,ct as We,et as Be,ft as Ce,it as Fe,k as O,lt as Se,nt as Me,o as Ae,p as I,pt as h,r as Ie,w as a}from"../chunks/BvhN-6Rm.js";import"../chunks/DwdwGuwu.js";import"../chunks/DDwXJn8G.js";import{a as U,d as Ne,i as t,n as Re,o as ke,t as E,u as ze}from"../chunks/gs4HCyIA.js";var Oe=Z('<tspan id="digit" y="25"> </tspan>'),Ue=Z('<tspan id="bar" y="45">―</tspan>'),Ve=Z('<tspan id="base" y="65"> <tspan baseline-shift="super" font-size="8"> </tspan></tspan> <tspan id="power" y="60"> </tspan>',1),Ge=K('<p class="w-100 tc"><svg height="80" font-family="sans-serif" font-weight="300" font-size="24" transform="scale(1.25)"><text x="10" y="20"></text><text x="10" y="45"></text><text x="10" y="70" font-size="12"></text></svg></p>');function l(V,m){Se(m,!1);let r=D(m,"top",24,()=>[]),b=D(m,"base",8),p=D(m,"base_str",12,"?"),w=Be(1),W=Be(30);p()==="?"&&b()!==void 0&&p(b().toString()),Ie(()=>{r().includes(".")&&Me(w,r().length-r().indexOf(".")),b()<=9&&b()>=2&&b()%1===0&&Me(W,24)}),Ae();var g=Ge(),_=C(g),y=C(_);P(y,5,r,G,(v,T,s)=>{var i=Oe();I(i,"x",15+s*30);var o=C(i,!0);h(i),H(()=>O(o,N(T))),M(v,i)}),h(y);var x=e(y);P(x,5,r,G,(v,T,s,i)=>{var o=Ue();I(o,"x",10+s*30),M(v,o)}),h(x);var S=e(x);P(S,5,r,G,(v,T,s,i)=>{var o=Ve(),u=J(o);I(u,"x",10+s*30);var A=C(u),j=e(A),R=C(j,!0);h(j),h(u);var $=e(u,2),k=C($,!0);h($),H(()=>{O(A,`(${p()??""})`),O(R,(L(r()),Q(()=>r().length-s))),I($,"x",N(W)+s*30),O(k,(L(r()),N(w),Q(()=>r().length-s-N(w))))}),M(v,o)}),h(S),h(_),h(g),H(()=>I(_,"width",(L(r()),Q(()=>15+r().length*30)))),M(V,g),We()}var He=K(`Consider the number first in base 10: 31.125. We will follow the process to
    ...
    base <!> also we can do the same.`,1),Le=K(`<!> <!> Numbers are usually represented in base 10, but they can be represented in any
...
number like 1234 would be <!> <!> <!>`,1);function Je(V,m){Se(m,!1);function r(d=[],q=-2,z="",B=""){d.reverse(),B.length===0&&(B=q.toString());let f="",n="";for(let c=0;c<d.length;c++){let F=d[c];f=`${F} \\cdot (${B})^${c}`+(f.length>0?" + ":"")+f,typeof q!="object"&&(n=`${F} \\cdot (${Math.pow(q,c).toFixed(2)})`+(n.length>0?" + ":"")+n)}return n.length>1&&(n="= "+n),t`${f} ${n} ${z}`}function b(d,q){return d.toString(q).toUpperCase()}Ae();var p=Le(),w=J(p);ke(w,{title:"Going to 3.14th base",sub:"Recreational Math #002",desc:"Bases other than positive integers",date:"29 May 2025"});var W=e(w,2);{let d=Fe(()=>[E("n","Variable. Usually positive integer"),E("r","Remainder. Usually < divisor base"),E("b","Base of number system")]);Re(W,{generics:{C:["z"],Hex:["A","F"]},get list(){return N(d)}})}var g=e(W,2);l(g,{top:[4,2,0],base:10});var _=e(g,2);a(_,()=>r([4,2,0],10,""));var y=e(_,2);a(y,()=>r([1,1,0,1,0,0,1,0,0],2,""));var x=e(y,2);l(x,{top:[1,1,0,1,0,0,1,0,0],base:2});var S=e(x,4);a(S,()=>U`
\\begin{align*}
	420 \\div 2 &= 210\\ &r\\ 0\\\\
	210 \\div 2 &= 105\\ &r\\ 0\\\\
	105 \\div 2 &= 52\\ &r\\ 1\\\\
	...
	3 \\div 2 &= 1\\ &r\\ 1
\\end{align*}
`);var v=e(S,2);a(v,()=>b(420,2));var T=e(v,2);a(T,()=>U`
\\begin{align*}
  420 \\div 7 &= 60\\ &r\\ 0\\\\
  60 \\div 7 &= 8\\ &r\\ 4\\\\
  8 \\div 7 &= 1\\ &r\\ 1\\\\
\\end{align*}
`);var s=e(T,2);a(s,()=>b(420,7));var i=e(s,2);l(i,{top:[1,1,4,0],base:7});var o=e(i,2);a(o,()=>t`b`);var u=e(o,2);a(u,()=>t`b-1`);var A=e(u,4);a(A,()=>t`b`);var j=e(A,2);a(j,()=>t`b-1`);var R=e(j,2);a(R,()=>t`|b|-1`);var $=e(R,2);a($,()=>t`b`);var k=e($,2);l(k,{top:[1,1,1,0],base:-2});var X=e(k,2);a(X,()=>r([1,1,1,0],-2,"= -6"));var Y=e(X,2);a(Y,()=>t`\\frac1n`);var ee=e(Y,2);Ne(ee,{title:"Base ½ example",children:(d,q)=>{Ce();var z=He(),B=e(J(z));a(B,()=>U`
  \\begin{align*}
    31 \\div 2 &= 15\\ &r\\ 1\\\\
    15 \\div 2 &= 7\\ &r\\ 1\\\\
    7 \\div 2 &= 3\\ &r\\ 1\\\\
    ...
    0.5 \\times 2 &= 1.0\\ &r\\ 1\\\\
  \\end{align*}
  `);var f=e(B,2);l(f,{top:[1,1,1,1,".",0,0,1],base:2});var n=e(f,2);a(n,()=>t`\\frac1n`);var c=e(n,2);l(c,{top:[1,0,0,1,".",1,1,1],base:1/2,base_str:"½"});var F=e(c,2);a(F,()=>t`b`);var qe=e(F,2);a(qe,()=>t`|b|-1`);var je=e(qe,2);a(je,()=>t`\\frac1b`),Ce(),M(d,z)},$$slots:{default:!0}});var ae=e(ee,2);a(ae,()=>t`\\frac1n`);var te=e(ae,2);a(te,()=>t`\\frac73`);var re=e(te,2);a(re,()=>U`
\\begin{align*}
