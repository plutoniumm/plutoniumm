import"../chunks/DsnmJJEf.js";import"../chunks/69_IOA4Y.js";import{p as De,aJ as Y,aK as ft,m as oe,g as t,a as Ce,s as e,c as i,u as s,aq as q,a7 as T,r as n,n as h,f as fe,d as Ka}from"../chunks/Cc-U2CFn.js";import{a as Z,f as be,e as Ae,t as Ja}from"../chunks/ecw0CP_J.js";import{h as a}from"../chunks/DCtWGmPh.js";import{i as Ge}from"../chunks/Bj7q6zUx.js";import{D as Ua,d as L,a as r,_ as M}from"../chunks/BP9avG_5.js";import{s as E}from"../chunks/DeJRxx7c.js";import{s as c,r as Me}from"../chunks/F8hb3Lht.js";import{e as Ma}from"../chunks/6ADeoIni.js";import{b as Ie}from"../chunks/CgYsFJFV.js";import{e as He,i as je}from"../chunks/zxXQGJud.js";import{i as We}from"../chunks/C81BIPVe.js";import{M as er}from"../chunks/DNjFuzX8.js";import{A as _t}from"../chunks/DvSWQ2_a.js";import{R as tr}from"../chunks/MKQfYD7l.js";var ar=be(`<div class="box tc mx-a my20 p10 rx10 svelte-1sjdl4q"><div class="f al-ct j-ct fw g10 mb10"><label class="svelte-1sjdl4q">p<sub>0→1</sub> = <b> </b> <input type="range" min="0" max="0.5" step="0.01" class="svelte-1sjdl4q"/></label> <label class="svelte-1sjdl4q">p<sub>1→0</sub> = <b> </b> <input type="range" min="0" max="0.5" step="0.01" class="svelte-1sjdl4q"/></label> <button class="svelte-1sjdl4q">re-toss</button></div> <svg width="480" height="186" font-family="monospace" font-size="10" class="svelte-1sjdl4q"><line x1="42" x2="468" stroke="#ddd"></line><line x1="42" x2="468" stroke="#999"></line><line x1="42" x2="468" stroke="#eee"></line><text x="38" text-anchor="end">1.0</text><text x="38" text-anchor="end">0.5</text><text x="38" text-anchor="end">0.0</text><polyline fill="none" stroke="#bbb" stroke-dasharray="3 3"></polyline><polyline fill="none" stroke="#bbb" stroke-dasharray="3 3"></polyline><line x1="42" x2="468" stroke="#c75200" stroke-dasharray="5 4"></line><text x="468" text-anchor="end" fill="#c75200"> </text><polyline fill="none" stroke="#097" stroke-width="1.5"></polyline><text x="255" y="182" text-anchor="middle" fill="#777"></text></svg> <div class="stat mt5 svelte-1sjdl4q"> <b> </b> · prediction from the SPAM formula <b> </b></div> <div class="note mt5 svelte-1sjdl4q">running mean of one noisy coin; the gray envelope is μ′ ± σ/√n. Set the
        two errors equal and the dashed line stays at 0.5; make them unequal and
        it shifts.</div></div>`);function rr(we,qe){De(qe,!1);const v=T(),m=T(),_=T(),O=T(),g=T(),H=T(),j=2**10;let k=T(0),$=T(0),W=T(0);const w=o=>{const d=Number(o);return Number.isFinite(d)?Math.min(.5,Math.max(0,d)):0};let y=T([]);const P=o=>42+o/(j-1)*426,u=o=>162-Math.min(1,Math.max(0,o))*142;Y(()=>(t(W),t(k),t($)),()=>{t(W);const o=w(t(k)),d=w(t($)),p=new Array(j);let x=0;for(let B=0;B<j;B++){let X=Math.random()<.5?1:0;X===0&&Math.random()<o?X=1:X===1&&Math.random()<d&&(X=0),x+=X,p[B]=x/(B+1)}q(y,p)}),Y(()=>(t(k),t($)),()=>{q(v,.5*(1+w(t(k))-w(t($))))}),Y(()=>t(v),()=>{q(m,Math.sqrt(t(v)*(1-t(v))))}),Y(()=>t(y),()=>{q(_,t(y)[j-1]||0)}),Y(()=>t(y),()=>{q(O,t(y).map((o,d)=>P(d).toFixed(1)+","+u(o).toFixed(1)).join(" "))}),Y(()=>(t(y),t(v),t(m)),()=>{q(g,t(y).map((o,d)=>d<3?"":P(d).toFixed(1)+","+u(t(v)+t(m)/Math.sqrt(d+1)).toFixed(1)).filter(o=>o.length>0).join(" "))}),Y(()=>(t(y),t(v),t(m)),()=>{q(H,t(y).map((o,d)=>d<3?"":P(d).toFixed(1)+","+u(t(v)-t(m)/Math.sqrt(d+1)).toFixed(1)).filter(o=>o.length>0).join(" "))}),ft(),Ge();var C=ar(),ie=i(C),Q=i(ie),G=e(i(Q),3),ue=i(G,!0);n(G);var ee=e(G,2);Me(ee),n(Q);var D=e(Q,2),te=e(i(D),3),_e=i(te,!0);n(te);var ne=e(te,2);Me(ne),n(D);var ce=e(D,2);n(ie);var K=e(ie,2),ae=i(K),se=e(ae),z=e(se),ve=e(z),re=e(ve),J=e(re),pe=e(J),le=e(pe),me=e(le),de=e(me),f=i(de);n(de);var b=e(de),N=e(b);N.textContent="shot number (1 … 1024)",n(K);var I=e(K,2),F=i(I);F.nodeValue="after 1024 shots: measured mean ";var A=e(F),S=i(A,!0);n(A);var V=e(A,2),l=i(V,!0);n(V),n(I),h(2),n(C),oe((o,d,p,x,B,X,R,U,Oe,Ve,Ze,Le,ze,Se,Re,Qe,$e)=>{E(ue,o),E(_e,d),c(ae,"y1",p),c(ae,"y2",x),c(se,"y1",B),c(se,"y2",X),c(z,"y1",R),c(z,"y2",U),c(ve,"y",Oe),c(re,"y",Ve),c(J,"y",Ze),c(pe,"points",t(g)),c(le,"points",t(H)),c(me,"y1",Le),c(me,"y2",ze),c(de,"y",Se),E(f,`μ′ = ${Re??""}`),c(b,"points",t(O)),E(S,Qe),E(l,$e)},[()=>(t(k),s(()=>w(t(k)).toFixed(2))),()=>(t($),s(()=>w(t($)).toFixed(2))),()=>s(()=>u(.5)),()=>s(()=>u(.5)),()=>s(()=>u(0)),()=>s(()=>u(0)),()=>s(()=>u(1)),()=>s(()=>u(1)),()=>s(()=>u(1)+3),()=>s(()=>u(.5)+3),()=>s(()=>u(0)+3),()=>(t(v),s(()=>u(t(v)))),()=>(t(v),s(()=>u(t(v)))),()=>(t(v),s(()=>u(t(v))-4)),()=>(t(v),s(()=>t(v).toFixed(3))),()=>(t(_),s(()=>t(_).toFixed(3))),()=>(t(v),s(()=>t(v).toFixed(3)))]),Ie(ee,()=>t(k),o=>q(k,o)),Ie(ne,()=>t($),o=>q($,o)),Ma("click",ce,()=>q(W,t(W)+1)),Z(we,C),Ce()}var or=Ae('<line x1="50" x2="470" stroke="#eee"></line><text x="46" text-anchor="end"> </text>',1),ir=Ae('<text y="228" text-anchor="middle"> </text>'),nr=Ae('<circle r="4" fill="#097"></circle>'),sr=be(`<div class="box tc mx-a my20 p10 rx10 svelte-tnnb7t"><div class="f al-ct j-ct fw g10 mb10"><label class="svelte-tnnb7t">p<sub>0→1</sub> = <b> </b> <input type="range" min="0" max="0.5" step="0.01" class="svelte-tnnb7t"/></label> <label class="svelte-tnnb7t">p<sub>1→0</sub> = <b> </b> <input type="range" min="0" max="0.5" step="0.01" class="svelte-tnnb7t"/></label> <button class="svelte-tnnb7t">re-toss</button></div> <svg width="480" height="240" font-family="monospace" font-size="10" class="svelte-tnnb7t"><!><!><line stroke="#c75200" stroke-dasharray="6 4" stroke-width="1.5"></line><!><text x="14" y="120" transform="rotate(-90 14 120)" text-anchor="middle" fill="#777">ln RSD</text><text x="260" y="239" text-anchor="middle" fill="#777">window size w (log axis)</text></svg> <div class="stat mt5 svelte-tnnb7t">intercept from the fit: <b> </b> · predicted from
        the error rates: <b> </b></div> <div class="note mt5 svelte-tnnb7t"></div></div>`);function lr(we,qe){De(qe,!1);const v=T(),m=256,_=[4,8,16,32,64,128],O=m*128;let g=T(.1),H=T(.3),j=T(0);const k=f=>{const b=Number(f);return Number.isFinite(b)?Math.min(.5,Math.max(0,b)):0};let $=T([]),W=T(0);const w=f=>50+(f-1.2)*420/3.8,y=f=>15+(.1-f)*195/3.2,P=Math.log(4),u=Math.log(128);Y(()=>(t(j),t(g),t(H)),()=>{t(j);const f=k(t(g)),b=k(t(H)),N=new Array(O);for(let A=0;A<O;A++){let S=Math.random()<.5?1:0;S===0&&Math.random()<f?S=1:S===1&&Math.random()<b&&(S=0),N[A]=S}const I=[];let F=0;for(const A of _){const S=[];for(let o=0;o<m;o++){let d=0;for(let p=0;p<A;p++)d+=N[o*A+p];S.push(d/A)}const V=S.reduce((o,d)=>o+d,0)/m;let l=0;for(const o of S)l+=(o-V)*(o-V);if(l=Math.sqrt(l/(m-1)),l>0&&V>0){const o=Math.log(A),d=Math.log(l/V);I.push({x:o,y:d,w:A}),F+=d+.5*o}}q($,I),q(W,I.length?F/I.length:0)}),Y(()=>(t(H),t(g)),()=>{q(v,.5*Math.log((1+k(t(H))-k(t(g)))/(1+k(t(g))-k(t(H)))))}),ft(),Ge();var C=sr(),ie=i(C),Q=i(ie),G=e(i(Q),3),ue=i(G,!0);n(G);var ee=e(G,2);Me(ee),n(Q);var D=e(Q,2),te=e(i(D),3),_e=i(te,!0);n(te);var ne=e(te,2);Me(ne),n(D);var ce=e(D,2);n(ie);var K=e(ie,2),ae=i(K);He(ae,0,()=>[-1,-2,-3],je,(f,b)=>{var N=or(),I=fe(N),F=e(I),A=i(F,!0);n(F),oe((S,V,l)=>{c(I,"y1",S),c(I,"y2",V),c(F,"y",l),E(A,b)},[()=>s(()=>y(b)),()=>s(()=>y(b)),()=>s(()=>y(b)+3)]),Z(f,N)});var se=e(ae);He(se,1,()=>_,je,(f,b)=>{var N=ir(),I=i(N,!0);n(N),oe(F=>{c(N,"x",F),E(I,t(b))},[()=>(t(b),s(()=>w(Math.log(t(b)))))]),Z(f,N)});var z=e(se),ve=e(z);He(ve,1,()=>t($),je,(f,b)=>{var N=nr();oe((I,F)=>{c(N,"cx",I),c(N,"cy",F)},[()=>(t(b),s(()=>w(t(b).x))),()=>(t(b),s(()=>y(t(b).y)))]),Z(f,N)}),h(2),n(K);var re=e(K,2),J=e(i(re)),pe=i(J);n(J);var le=e(J,2),me=i(le);n(le),n(re);var de=e(re,2);de.textContent=`32768 simulated shots, 256 windows of each size. Dots are the measured ln
        RSD; the dashed line has slope −1/2 and the predicted intercept.`,n(C),oe((f,b,N,I,F,A,S,V)=>{E(ue,f),E(_e,b),c(z,"x1",N),c(z,"y1",I),c(z,"x2",F),c(z,"y2",A),E(pe,`c = ${S??""}`),E(me,`c = ${V??""}`)},[()=>(t(g),s(()=>k(t(g)).toFixed(2))),()=>(t(H),s(()=>k(t(H)).toFixed(2))),()=>s(()=>w(P)),()=>(t(v),s(()=>y(t(v)-.5*P))),()=>s(()=>w(u)),()=>(t(v),s(()=>y(t(v)-.5*u))),()=>(t(W),s(()=>t(W).toFixed(3))),()=>(t(v),s(()=>t(v).toFixed(3)))]),Ie(ee,()=>t(g),f=>q(g,f)),Ie(ne,()=>t(H),f=>q(H,f)),Ma("click",ce,()=>q(j,t(j)+1)),Z(we,C),Ce()}var dr=Ae('<line x1="50" x2="470" stroke="#eee"></line><text x="46" text-anchor="end"> </text>',1),hr=Ae('<line y1="15" y2="195" stroke="#f3f3f3"></line><text y="208" text-anchor="middle"> </text>',1),cr=Ae('<line x1="50" x2="470" stroke="#555" stroke-dasharray="2 3"></line><text x="468" text-anchor="end" fill="#555">floor B</text>',1),vr=Ae('<line y1="15" y2="195" stroke="#c75200" stroke-dasharray="4 3"></line><circle r="4.5" fill="#c75200"></circle>',1),pr=be('<div class="stat mt5 svelte-3rmsx7"> <b> </b> <!></div>'),mr=be('<div class="stat bad mt5 svelte-3rmsx7"> </div>'),ur=be(`<div class="box tc mx-a my20 p10 rx10 svelte-3rmsx7"><div class="f al-ct j-ct fw g10 mb10"><label class="svelte-3rmsx7">A (statistical) = <b> </b> <input type="range" min="1" max="100" step="1" class="svelte-3rmsx7"/></label> <label class="svelte-3rmsx7">B (bias floor) = <b> </b> <input type="range" min="0" max="0.02" step="0.001" class="svelte-3rmsx7"/></label> <label class="svelte-3rmsx7">target σ² = <b> </b> <input type="range" min="0.001" max="0.05" step="0.001" class="svelte-3rmsx7"/></label></div> <svg width="480" height="225" font-family="monospace" font-size="10" class="svelte-3rmsx7"><!><!><!><line x1="50" x2="470" stroke="#d22" stroke-dasharray="6 4"></line><text x="54" fill="#d22">target σ²</text><polyline fill="none" stroke="#097" stroke-width="1.8"></polyline><!><text x="260" y="222" text-anchor="middle" fill="#777">shots N (log axis)</text><text x="14" y="105" transform="rotate(-90 14 105)" text-anchor="middle" fill="#777">Var (log axis)</text></svg> <!> <div class="note mt5 svelte-3rmsx7">Var(Ē<sub>N</sub>) = A/N + B on log-log axes. The curve falls as 1/N
        until the bias floor takes over; the marked point is where it crosses
        the target.</div></div>`);function _r(we,qe){De(qe,!1);const v=T(),m=T(),_=T(),O=T(),g=T(),H=T();let j=T(56),k=T(.002),$=T(.01);const W=(l,o,d)=>{const p=Number(l);return Number.isFinite(p)?Math.min(d,Math.max(o,p)):o},w=l=>Math.log(l)/Math.LN10,y=l=>50+(l-1)*420/4,P=l=>15+(1-l)*180/4,u=l=>Math.min(1.2,Math.max(-3.2,l));let C=T("");const ie=[[1,"10"],[2,"100"],[3,"1k"],[4,"10k"],[5,"100k"]],Q=[[0,"1"],[-1,"0.1"],[-2,"0.01"],[-3,"0.001"]];Y(()=>t(j),()=>{q(v,W(t(j),1,100))}),Y(()=>t(k),()=>{q(m,W(t(k),0,.02))}),Y(()=>t($),()=>{q(_,W(t($),.001,.05))}),Y(()=>(t(_),t(m)),()=>{q(O,t(_)>t(m))}),Y(()=>(t(O),t(v),t(_),t(m)),()=>{q(g,t(O)?t(v)/(t(_)-t(m)):0)}),Y(()=>(t(O),t(g)),()=>{q(H,t(O)?Math.ceil(t(g)):0)}),Y(()=>(t(v),t(m)),()=>{const l=[];for(let o=0;o<=84;o++){const d=1+4*o/84,p=Math.pow(10,d),x=u(w(t(v)/p+t(m)));l.push(y(d).toFixed(1)+","+P(x).toFixed(1))}q(C,l.join(" "))}),ft(),Ge();var G=ur(),ue=i(G),ee=i(ue),D=e(i(ee)),te=i(D,!0);n(D);var _e=e(D,2);Me(_e),n(ee);var ne=e(ee,2),ce=e(i(ne)),K=i(ce,!0);n(ce);var ae=e(ce,2);Me(ae),n(ne);var se=e(ne,2),z=e(i(se)),ve=i(z,!0);n(z);var re=e(z,2);Me(re),n(se),n(ue);var J=e(ue,2),pe=i(J);He(pe,1,()=>Q,je,(l,o)=>{var d=dr(),p=fe(d),x=e(p),B=i(x,!0);n(x),oe((X,R,U)=>{c(p,"y1",X),c(p,"y2",R),c(x,"y",U),E(B,(t(o),s(()=>t(o)[1])))},[()=>(t(o),s(()=>P(t(o)[0]))),()=>(t(o),s(()=>P(t(o)[0]))),()=>(t(o),s(()=>P(t(o)[0])+3))]),Z(l,d)});var le=e(pe);He(le,1,()=>ie,je,(l,o)=>{var d=hr(),p=fe(d),x=e(p),B=i(x,!0);n(x),oe((X,R,U)=>{c(p,"x1",X),c(p,"x2",R),c(x,"x",U),E(B,(t(o),s(()=>t(o)[1])))},[()=>(t(o),s(()=>y(t(o)[0]))),()=>(t(o),s(()=>y(t(o)[0]))),()=>(t(o),s(()=>y(t(o)[0])))]),Z(l,d)});var me=e(le);{var de=l=>{var o=cr(),d=fe(o),p=e(d);oe((x,B,X)=>{c(d,"y1",x),c(d,"y2",B),c(p,"y",X)},[()=>(t(m),s(()=>P(u(w(t(m)))))),()=>(t(m),s(()=>P(u(w(t(m)))))),()=>(t(m),s(()=>P(u(w(t(m))))-4))]),Z(l,o)};We(me,l=>{t(m)>0&&l(de)})}var f=e(me),b=e(f),N=e(b),I=e(N);{var F=l=>{var o=vr(),d=fe(o),p=e(d);oe((x,B,X,R)=>{c(d,"x1",x),c(d,"x2",B),c(p,"cx",X),c(p,"cy",R)},[()=>(t(g),s(()=>y(w(t(g))))),()=>(t(g),s(()=>y(w(t(g))))),()=>(t(g),s(()=>y(w(t(g))))),()=>(t(_),s(()=>P(u(w(t(_))))))]),Z(l,o)};We(I,l=>{t(O)&&t(g)>=10&&t(g)<=1e5&&l(F)})}h(2),n(J);var A=e(J,2);{var S=l=>{var o=pr(),d=i(o),p=e(d),x=i(p);n(p);var B=e(p,2);{var X=R=>{var U=Ja("(beyond the right edge of the chart)");Z(R,U)};We(B,R=>{t(g)>1e5&&R(X)})}n(o),oe((R,U)=>{E(d,`N = A / (σ² − B) = ${t(v)??""} / ${R??""} = `),E(x,`${U??""} shots`)},[()=>(t(_),t(m),s(()=>(t(_)-t(m)).toFixed(3))),()=>(t(H),s(()=>t(H).toLocaleString("en-US")))]),Z(l,o)},V=l=>{var o=mr(),d=i(o);n(o),oe((p,x)=>E(d,`the target σ² = ${p??""} sits at or below the floor B = ${x??""}: no number of shots reaches it`),[()=>(t(_),s(()=>t(_).toFixed(3))),()=>(t(m),s(()=>t(m).toFixed(3)))]),Z(l,o)};We(A,l=>{t(O)?l(S):l(V,!1)})}h(2),n(G),oe((l,o,d,p,x)=>{E(te,t(v)),E(K,l),E(ve,o),c(f,"y1",d),c(f,"y2",p),c(b,"y",x),c(N,"points",t(C))},[()=>(t(m),s(()=>t(m).toFixed(3))),()=>(t(_),s(()=>t(_).toFixed(3))),()=>(t(_),s(()=>P(u(w(t(_)))))),()=>(t(_),s(()=>P(u(w(t(_)))))),()=>(t(_),s(()=>P(u(w(t(_))))-4))]),Ie(_e,()=>t(j),l=>q(j,l)),Ie(ae,()=>t(k),l=>q(k,l)),Ie(re,()=>t($),l=>q($,l)),Z(we,G),Ce()}var fr=be(`<p>The clean way to track both decays at once is the Jaynes-Cummings
        ...
        as a bias of the coin.</p>`,1),br=be(`<p>Take <!> independent bits where a 1 flips to 0 with probability <!> and a 0 flips to 1 with probability <!>. The variance
        ...
        covariance. There is no universal formula to aim for.</p>`,1),gr=be(`<p>In the minimal STO-3G basis the <!> Hamiltonian compiles to a sum of
        ...
        is what the <!> model describes.</p>`,1),xr=be(`<!> <p>A quantum computer hands you one sample from a probability distribution
    ...
    machine is already expensive.</p> <h3>Noise that hides and noise that shifts</h3> <p>The first noise source is the most mundane: the machine sometimes reads the
    ...
    on two independent noisy simulators, IBM's and CERN's, both set to <!>.</p> <!> <h3>One number per qubit</h3> <p>To compare spreads across different means we switch from <!> to the relative
    ...
    achieved <!>. The widget below is this equation made
    draggable.</p> <!> <p>The variance does carry its own price: <!> means
    ...
    through the fitted <!> and <!>, and the curve, once fitted at small
    shot counts, can be evaluated at any <!>. So if the production run
    ...
    already prices it:</p> <!> <p>The expensive run buys the precision; a handful of cheap runs is enough to
...
\\end{aligned}
`);var C=e(u,2),ie=e(i(C));a(ie,()=>r`1/\\sqrt{N}`),h(),n(C);var Q=e(C,4),G=e(i(Q));a(G,()=>r`p_{0 \\to 1}`);var ue=e(G,2);a(ue,()=>r`p_{1 \\to 0}`),h(),n(Q);var ee=e(Q,2);a(ee,()=>M`
\\mu' = P(1) + p_{0\\to1}\\,P(0) - p_{1\\to0}\\,P(1)
`);var D=e(ee,2),te=e(i(D));a(te,()=>r`P(0) = P(1) = 0.5`);var _e=e(te,2);a(_e,()=>r`p_{0\\to1} = 0.33`);var ne=e(_e,2);a(ne,()=>r`p_{1\\to0} = 0.5`),h(),n(D);var ce=e(D,2);a(ce,()=>M`
\\mu' = 0.5 + 0.33 \\times 0.5 - 0.5 \\times 0.5 = 0.415
`);var K=e(ce,2),ae=e(i(K));a(ae,()=>r`\\mu' = 0.5`);var se=e(ae,2);a(se,()=>r`p_{0\\to1} = p_{1\\to0} = 0.33`),h(),n(K);var z=e(K,2);rr(z,{});var ve=e(z,4),re=e(i(ve));a(re,()=>r`\\sigma`);var J=e(re,2);a(J,()=>r`\\text{RSD} = \\sigma/\\mu`);var pe=e(J,2);a(pe,()=>r`2^{15}`);var le=e(pe,2);a(le,()=>r`w`);var me=e(le,2);a(me,()=>r`w = 4, 8, 16, \\ldots,
    128`),h(),n(ve);var de=e(ve,2);a(de,()=>M`
\\ln(\\text{RSD}) = -\\tfrac{1}{2}\\ln w + c
`);var f=e(de,2),b=e(i(f));a(b,()=>r`-1/2`);var N=e(b,2);a(N,()=>r`c`);var I=e(N,2);a(I,()=>r`p`);var F=e(I,2);a(F,()=>r`p`);var A=e(F,2);a(A,()=>r`\\sqrt{p(1-p)/w}`),h(),n(f);var S=e(f,2);a(S,()=>M`
\\begin{aligned}
c &= \\ln\\frac{\\sigma}{\\mu} + \\tfrac{1}{2}\\ln w
= \\ln\\frac{\\sqrt{p(1-p)/w}}{p} + \\tfrac{1}{2}\\ln w\\\\
&= \\tfrac{1}{2}\\ln\\frac{1-p}{p} = \\tfrac{1}{2}\\ln\\frac{p_0}{p_1}
\\end{aligned}
`);var V=e(S,2),l=e(i(V));a(l,()=>r`p_0 = p_1`);var o=e(l,2);a(o,()=>r`c = 0`);var d=e(o,2);a(d,()=>r`\\mu' = 0.415`),h(),n(V);var p=e(V,2);a(p,()=>M`
c = \\tfrac{1}{2}\\ln\\frac{0.585}{0.415} = 0.172
`);var x=e(p,2),B=e(i(x));a(B,()=>r`\\mu'`);var X=e(B,2);a(X,()=>r`p`),h(),n(x);var R=e(x,2);a(R,()=>M`
c_{\\text{pred}} = \\tfrac{1}{2}\\ln\\!\\left(\\frac{1 + p_{1\\to0} - p_{0\\to1}}{1 + p_{0\\to1} - p_{1\\to0}}\\right)
`);var U=e(R,2),Oe=e(i(U));a(Oe,()=>r`c_{\\text{pred}} = 0`);var Ve=e(Oe,2);a(Ve,()=>r`x`);var Ze=e(Ve,2);a(Ze,()=>r`dc/dx =
    \\pm 2/(x^2 - 1)`);var Le=e(Ze,2);a(Le,()=>r`x`),h(3),n(U);var ze=e(U,2);lr(ze,{});var Se=e(ze,2),Re=e(i(Se));a(Re,()=>r`c`);var Qe=e(Re,2);a(Qe,()=>r`c`),h(),n(Se);var $e=e(Se,4),bt=e(i($e));a(bt,()=>r`|1\\rangle`);var gt=e(bt,2);a(gt,()=>r`|0\\rangle`);var xt=e(gt,2);a(xt,()=>r`T_1`);var yt=e(xt,2);a(yt,()=>r`t`);var wt=e(yt,2);a(wt,()=>r`H`);var Ia=e(wt,2);a(Ia,()=>r`\\varepsilon = 1 -
    e^{-t/T_1}`),h(),n($e);var qt=e($e,2);a(qt,()=>M`
p_0' = p_0 + p_1\\,\\varepsilon, \\qquad p_1' = p_1\\,(1 - \\varepsilon)
`);var Ke=e(qt,2),Aa=e(i(Ke));a(Aa,()=>r`b`),h(),n(Ke);var Tt=e(Ke,2);a(Tt,()=>M`
c_{\\text{pred}} = \\tfrac{1}{2}\\ln\\!\\left(\\frac{b\\,(1-p_{0\\to1}) + p_{1\\to0}}{b\\,p_{0\\to1} + 1 - p_{1\\to0}}\\right),
\\qquad b = \\frac{1+\\varepsilon}{1-\\varepsilon}
`);var Je=e(Tt,2),kt=e(i(Je));a(kt,()=>r`\\varepsilon \\to 0`);var Nt=e(kt,2);a(Nt,()=>r`b \\to 1`);var Mt=e(Nt,2);a(Mt,()=>r`c = \\tfrac{1}{2}\\ln b`);var Pa=e(Mt,2);a(Pa,()=>r`T_1 = 232`),h(),n(Je);var It=e(Je,2);a(It,()=>M`
\\begin{aligned}
...
`);var Ue=e(It,4),At=e(i(Ue));a(At,()=>r`T_2`);var Pt=e(At,4);a(Pt,()=>r`H`);var Ft=e(Pt,2);a(Ft,()=>r`H`);var St=e(Ft,2);a(St,()=>r`\\varepsilon_2 =
    e^{-t/T_2}`);var $t=e(St,2);a($t,()=>r`b =
    (1+\\varepsilon_2)/(1-\\varepsilon_2)`);var Fa=e($t,2);a(Fa,()=>r`T_1`),h(),n(Ue);var Bt=e(Ue,2);_t(Bt,{title:"Where the decay factor b comes from",children:(Te,Na)=>{var ge=fr(),he=fe(ge),ke=e(i(he));a(ke,()=>r`\\alpha|0\\rangle + \\beta|1\\rangle`);var xe=e(ke,2);a(xe,()=>r`T_1, T_2`);var ye=e(xe,2);a(ye,()=>r`t`);var Ne=e(ye,2);a(Ne,()=>r`\\varepsilon_1 = e^{-t/T_1}`);var Pe=e(Ne,2);a(Pe,()=>r`\\varepsilon_2 = e^{-t/T_2}`),h(),n(he);var Fe=e(he,2);a(Fe,()=>M`
    \\rho_{T_1+T_2} = \\begin{pmatrix}
    1 + (|\\alpha|^2 - 1)\\,\\varepsilon_1 & \\alpha\\beta^*\\,\\varepsilon_2\\\\
    \\alpha^*\\beta\\,\\varepsilon_2 & |\\beta|^2\\,\\varepsilon_1
    \\end{pmatrix}
    `);var Be=e(Fe,2),Xe=e(i(Be));a(Xe,()=>r`\\varepsilon_1`);var Ee=e(Xe,2);a(Ee,()=>r`\\varepsilon_2`);var Ye=e(Ee,2);a(Ye,()=>r`T_1`),h(),n(Be),Z(Te,ge)},$$slots:{default:!0}});var et=e(Bt,2),Xt=e(i(et));a(Xt,()=>r`T_2`);var Sa=e(Xt,2);a(Sa,()=>r`\\sigma_{T_2}`),h(),n(et);var Et=e(et,2);a(Et,()=>M`
\\begin{aligned}
...
\\end{aligned}
`);var tt=e(Et,2),Ht=e(i(tt));a(Ht,()=>r`\\delta t`);var jt=e(Ht,2);a(jt,()=>r`1/T_2^2`);var Ot=e(jt,2);a(Ot,()=>r`c`);var Vt=e(Ot,2);a(Vt,()=>r`t \\to 0`);var $a=e(Vt,2);a($a,()=>r`\\sigma_c \\to 0`),h(),n(tt);var at=e(tt,4),Zt=e(i(at));a(Zt,()=>r`X`);var zt=e(Zt,2);a(zt,()=>r`Y`);var Rt=e(zt,2);a(Rt,()=>r`Z`);var Yt=e(Rt,2);a(Yt,()=>r`E`);var Wt=e(Yt,2);a(Wt,()=>r`p_x = p_y = p_z = E/3`);var Ba=e(Wt,2);a(Ba,()=>r`k`),h(),n(at);var Dt=e(at,2);a(Dt,()=>M`
P_k = 1 - (1-p)^k \\approx k\\,p
`);var rt=e(Dt,2),Ct=e(i(rt));a(Ct,()=>r`p = 0.001`);var Gt=e(Ct,2);a(Gt,()=>r`k = 50`);var Lt=e(Gt,2);a(Lt,()=>r`1 - 0.999^{50} = 0.0488`);var Xa=e(Lt,2);a(Xa,()=>r`0.05`),h(),n(rt);var ot=e(rt,2),Ea=e(i(ot));a(Ea,()=>r`k \\le 1/p`),h(),n(ot);var it=e(ot,6),Ha=e(i(it));a(Ha,()=>r`c`),h(),n(it);var Qt=e(it,4);a(Qt,()=>M`
\\mathrm{Var}(X_1 + X_2) = \\mathrm{Var}(X_1) + \\mathrm{Var}(X_2) + 2\\,\\mathrm{Cov}(X_1, X_2)
`);var Kt=e(Qt,4);a(Kt,()=>M`
\\binom{100}{2} = \\frac{100 \\times 99}{2} = 4950
`);var Jt=e(Kt,4);_t(Jt,{title:"How bits combine decides the variance",children:(Te,Na)=>{var ge=br(),he=fe(ge),ke=e(i(he));a(ke,()=>r`k`);var xe=e(ke,2);a(xe,()=>r`p`);var ye=e(xe,2);a(ye,()=>r`q`);var Ne=e(ye,2);a(Ne,()=>r`i`),h(),n(he);var Pe=e(he,2);a(Pe,()=>M`
    \\mathrm{Var}(X_i) = (1 - p + q)(p - q)\\cdot 2^i
    `);var Fe=e(Pe,2),Be=e(i(Fe));a(Be,()=>r`101010_2 = 42`);var Xe=e(Be,2);a(Xe,()=>r`2^i`);var Ee=e(Xe,2);a(Ee,()=>r`p`);var Ye=e(Ee,2);a(Ye,()=>r`q`);var La=e(Ye,2);a(La,()=>r`0.0110101_2 \\approx 0.42`),h(),n(Fe);var Qa=e(Fe,2);a(Qa,()=>M`
    \\mathrm{Var}(X_1 X_2) = \\left(\\mathrm{Var}(X_1) + \\mu_1^2\\right)\\left(\\mathrm{Var}(X_2) + \\mu_2^2\\right) - \\mu_1^2\\,\\mu_2^2
    `),h(2),Z(Te,ge)},$$slots:{default:!0}});var nt=e(Jt,4),Ut=e(i(nt));a(Ut,()=>r`\\langle O \\rangle`);var ja=e(Ut,2);a(ja,()=>r`O`),h(),n(nt);var ea=e(nt,2);a(ea,()=>M`
\\sigma^2 = \\mathrm{Var}(O) = \\langle O^2 \\rangle - \\langle O \\rangle^2
`);var st=e(ea,2),ta=e(i(st));a(ta,()=>r`N`);var aa=e(ta,2);a(aa,()=>r`\\mathrm{Var}(\\bar E_N) = \\sigma^2/N`);var Oa=e(aa,2);a(Oa,()=>r`-1`),h(),n(st);var ra=e(st,2);a(ra,()=>M`
\\mathrm{Var}(\\bar E_N) = \\frac{A}{N} + B, \\qquad A \\approx \\sigma^2,\\quad B \\ge 0
`);var lt=e(ra,2),oa=i(lt);a(oa,()=>r`A`);var ia=e(oa,2);a(ia,()=>r`B`);var na=e(ia,2);a(na,()=>r`c`);var sa=e(na,2);a(sa,()=>r`\\langle O \\rangle`);var la=e(sa,2);a(la,()=>r`\\langle O^2 \\rangle`);var da=e(la,2);a(da,()=>r`A`);var Va=e(da,2);a(Va,()=>r`B`),h(),n(lt);var dt=e(lt,4),ha=e(i(dt));a(ha,()=>r`H_2`);var Za=e(ha,2);a(Za,()=>r`\\pm 1`),h(),n(dt);var ca=e(dt,2);_t(ca,{title:"The actual Hamiltonian",children:(Te,Na)=>{var ge=gr(),he=fe(ge),ke=e(i(he));a(ke,()=>r`H_2`),h(),n(he);var xe=e(he,2);a(xe,()=>M`
    \\begin{aligned}
    ...
    \\end{aligned}
    `);var ye=e(xe,2),Ne=e(i(ye));a(Ne,()=>r`\\bar E_N`);var Pe=e(Ne,2);a(Pe,()=>r`A/N + B`),h(),n(ye),Z(Te,ge)},$$slots:{default:!0}});var ht=e(ca,2),za=e(i(ht));a(za,()=>r`\\bar E_N`),h(),n(ht);var va=e(ht,2);a(va,()=>M`
\\mathrm{SE}(s^2) = s^2\\sqrt{\\frac{2}{N-1}}, \\qquad
s^2 = \\frac{1}{N-1}\\sum_{i=1}^{N}\\left(E_i - \\bar E_N\\right)^2
`);var ct=e(va,2),pa=e(i(ct));a(pa,()=>r`N`);var Ra=e(pa,2);a(Ra,()=>r`p`),h(),n(ct);var ma=e(ct,2);a(ma,()=>M`
N > \\frac{2 \\times 10^4}{p^2}: \\qquad
p = 2 \\;\\Rightarrow\\; N > 5000, \\qquad
p = 1 \\;\\Rightarrow\\; N > 20\\,000
`);var vt=e(ma,2),ua=e(i(vt));a(ua,()=>r`A/N + B`);var _a=e(ua,2);a(_a,()=>r`N = 32`);var Ya=e(_a,2);a(Ya,()=>r`\\sqrt{2/(N-1)}`),h(),n(vt);var fa=e(vt,4);a(fa,()=>M`
N = \\frac{A}{\\sigma^2 - B} = \\frac{56}{0.01 - 0.002} = 7000
`);var pt=e(fa,2),Wa=e(i(pt));a(Wa,()=>r`\\sigma^2 \\approx 0.01`),h(),n(pt);var ba=e(pt,2);_r(ba,{});var mt=e(ba,2),ga=e(i(mt));a(ga,()=>r`\\langle O^2 \\rangle`);var xa=e(ga,2);a(xa,()=>r`A`);var ya=e(xa,2);a(ya,()=>r`B`);var Da=e(ya,2);a(Da,()=>r`N`),h(),n(mt);var wa=e(mt,2);a(wa,()=>M`
\\mathrm{Var}(\\bar E_{50\\,000}) = \\frac{56}{50\\,000} + 0.002 \\approx 0.0031
`);var ut=e(wa,4),qa=e(i(ut));a(qa,()=>r`A`);var Ta=e(qa,2);a(Ta,()=>r`B`);var ka=e(Ta,2);a(ka,()=>r`B`);var Ca=e(ka,2);a(Ca,()=>r`c`),h(),n(ut);var Ga=e(ut,2);tr(Ga,{list:[["Estimating shots and variance on noisy quantum circuits (Seksaria & Prabhakar, 2025)","https://arxiv.org/abs/2501.03194"],["Quantum Computing in the NISQ era and beyond (Preskill, 2018)","https://arxiv.org/abs/1801.00862"],["A variational eigenvalue solver on a photonic quantum processor (Peruzzo et al., 2014)","https://www.nature.com/articles/ncomms5213"],["Benchmarking quantum processor performance at scale (McKay et al., 2023; EPLG)","https://arxiv.org/abs/2311.05933"],["A quantum engineer's guide to superconducting qubits (Krantz et al., 2019)","https://arxiv.org/abs/1904.06560"]]}),Z(we,v),Ce()}export{Hr as component};
