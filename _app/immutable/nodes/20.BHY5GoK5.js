import"../chunks/DsnmJJEf.js";import"../chunks/sDYslN56.js";import{p as Me,t as H,a as _e,c as S,s as e,ao as Ce,r as l,W as V,u as D,a4 as Se,g as R,f as E,n as Be,d as Ie}from"../chunks/CZzIV55D.js";import{a as B,f as K,d as X}from"../chunks/BlMiFbA4.js";import{h as a}from"../chunks/DS88NDGo.js";import{i as je}from"../chunks/Cip6YPdY.js";import{D as Re,d as J}from"../chunks/BgxUS35f.js";import{o as ke}from"../chunks/DY9qbGRG.js";import{s as O}from"../chunks/CVLMyftS.js";import{e as L,i as P}from"../chunks/DMALeH6E.js";import{s as I}from"../chunks/DXlEpTQd.js";import{p as Q}from"../chunks/B0Vyv0Pp.js";import{M as Ne,_ as U,a as t}from"../chunks/Ca4_tEOp.js";import{A as ze}from"../chunks/JfG-0PZC.js";import{R as Oe}from"../chunks/CIMe7u3z.js";var Ue=X('<tspan id="digit" y="25"> </tspan>'),Ge=X('<tspan id="bar" y="45">―</tspan>'),He=X('<tspan id="base" y="65"> <tspan baseline-shift="super" font-size="8"> </tspan></tspan> <tspan id="power" y="60"> </tspan>',1),Ve=K('<p class="w-100 tc"><svg height="80" font-family="sans-serif" font-weight="300" font-size="24" transform="scale(1.25)"><text x="10" y="20"></text><text x="10" y="45"></text><text x="10" y="70" font-size="12"></text></svg></p>');function b(G,f){Me(f,!1);let r=Q(f,"top",24,()=>[]),d=Q(f,"base",8),p=Q(f,"base_str",12,"?"),w=Se(1),M=Se(30);p()==="?"&&d()!==void 0&&p(d().toString()),ke(()=>{r().includes(".")&&Ce(w,r().length-r().indexOf(".")),d()<=9&&d()>=2&&d()%1==0&&Ce(M,24)}),je();var g=Ve(),y=S(g),x=S(y);L(x,5,r,P,(v,q,s)=>{var o=Ue();I(o,"x",15+30*s);var i=S(o,!0);l(o),H(()=>O(i,R(q))),B(v,o)}),l(x);var T=e(x);L(T,5,r,P,(v,q,s,o)=>{var i=Ge();I(i,"x",10+30*s),B(v,i)}),l(T);var _=e(T);L(_,5,r,P,(v,q,s,o)=>{var i=He(),u=E(i);I(u,"x",10+30*s);var j=S(u),A=e(j),k=S(A,!0);l(A),l(u);var $=e(u,2),N=S($,!0);l($),H(()=>{O(j,`(${p()??""})`),O(k,(V(r()),D(()=>r().length-s))),I($,"x",R(M)+30*s),O(N,(V(r()),R(w),D(()=>r().length-s-R(w))))}),B(v,i)}),l(_),l(y),l(g),H(()=>I(y,"width",(V(r()),D(()=>15+30*r().length)))),B(G,g),_e()}var De=K(`Consider the number first in base 10: 31.125. We will follow the process to
...
number like 1234 would be <!> <!> <!>`,1);function oa(G,f){function r(h=[],W=-2,z="",C=""){h.reverse(),C.length===0&&(C=W.toString());let c="",n="";for(let m=0;m<h.length;m++){let F=h[m];c=`${F} \\cdot (${C})^${m}`+(c.length>0?" + ":"")+c,typeof W!="object"&&(n=`${F} \\cdot (${Math.pow(W,m).toFixed(2)})`+(n.length>0?" + ":"")+n)}return n.length>1&&(n="= "+n),t`${c} ${n} ${z}`}function d(h,W){return h.toString(W).toUpperCase()}Me(f,!1),je();var p=Je(),w=E(p);Ne(w,{title:"Going to 3.14th base",sub:"Recreational Math #002",desc:"Bases other than positive integers",date:"29 May 2025"});var M=e(w,2);{let h=Ie(()=>[J("n","Variable. Usually positive integer"),J("r","Remainder. Usually < divisor base"),J("b","Base of number system")]);Re(M,{generics:{C:["z"],Hex:["A","F"]},get list(){return R(h)}})}var g=e(M,2);b(g,{top:[4,2,0],base:10});var y=e(g,2);a(y,()=>r([4,2,0],10,""));var x=e(y,2);a(x,()=>r([1,1,0,1,0,0,1,0,0],2,""));var T=e(x,2);b(T,{top:[1,1,0,1,0,0,1,0,0],base:2});var _=e(T,4);a(_,()=>U`
\\begin{align*}
	420 \\div 2 &= 210\\ &r\\ 0\\\\
	210 \\div 2 &= 105\\ &r\\ 0\\\\
	105 \\div 2 &= 52\\ &r\\ 1\\\\
...
\\begin{align*}
  ...
  8 \\div 7 &= 1\\ &r\\ 1\\\\
\\end{align*}
`);var s=e(q,2);a(s,()=>d(420,7));var o=e(s,2);b(o,{top:[1,1,4,0],base:7});var i=e(o,2);a(i,()=>t`b`);var u=e(i,2);a(u,()=>t`b-1`);var j=e(u,4);a(j,()=>t`b`);var A=e(j,2);a(A,()=>t`b-1`);var k=e(A,2);a(k,()=>t`|b|-1`);var $=e(k,2);a($,()=>t`b`);var N=e($,2);b(N,{top:[1,1,1,0],base:-2});var Y=e(N,2);a(Y,()=>r([1,1,1,0],-2,"= -6"));var Z=e(Y,2);a(Z,()=>t`\\frac1n`);var ee=e(Z,2);ze(ee,{title:"Base ½ example",children:(h,W)=>{Be();var z=De(),C=e(E(z));a(C,()=>U`
  \\begin{align*}
    31 \\div 2 &= 15\\ &r\\ 1\\\\
    15 \\div 2 &= 7\\ &r\\ 1\\\\
    7 \\div 2 &= 3\\ &r\\ 1\\\\
    ...
    0.5 \\times 2 &= 1.0\\ &r\\ 1\\\\
  \\end{align*}
  `);var c=e(C,2);b(c,{top:[1,1,1,1,".",0,0,1],base:2});var n=e(c,2);a(n,()=>t`\\frac1n`);var m=e(n,2);b(m,{top:[1,0,0,1,".",1,1,1],base:.5,base_str:"½"});var F=e(m,2);a(F,()=>t`b`);var We=e(F,2);a(We,()=>t`|b|-1`);var Fe=e(We,2);a(Fe,()=>t`\\frac1b`),Be(),B(h,z)},$$slots:{default:!0}});var ae=e(ee,2);a(ae,()=>t`\\frac1n`);var te=e(ae,2);a(te,()=>t`\\frac73`);var re=e(te,2);a(re,()=>U`
\\begin{align*}
