import{$ as e,A as P,M as X,Q,R as H,Z as L,ct as Z,ft as E,it as K,lt as U,o as ee,pt as V,w as a}from"../chunks/BvhN-6Rm.js";import"../chunks/DwdwGuwu.js";import"../chunks/DDwXJn8G.js";import{a as i,d as ae,i as t,n as te,o as ie,t as n,u as ne}from"../chunks/gs4HCyIA.js";var re=X(`The way the Taylor's series is defined in its discrete form is as follows: <!> We can generalize this to a continuous form by replacing the factorial with
    the gamma function, and some more obvious changes: <!>`,1),oe=X(`<!> <!> We usually find derivatives of functions at integer orders, such as 1st, 2nd,
...
Giving us <!> Absolute insanity. <!> <!>`,1);function ve(J,Y){U(Y,!1),ee();var d=oe(),f=Q(d);ie(f,{title:"Fractional, complex, and complex fractional derivatives",sub:"Recreational Math #003",desc:"Non-integer and other continuous derivatives.",date:"29 June 2025"});var c=e(f,2);{let s=K(()=>[n("D","Derivative operator"),n("k","Variable positive integer"),n("α","Variable real"),n("a","the point the Taylor series is expanded around"),n("t","continuous derivative order, integrated over in the continuous Taylor series")]);te(c,{generics:{N:["n"],R:["x","y","z"],fXX:["f"]},get list(){return H(s)}})}var l=e(c,2);a(l,()=>i`
\\begin{gathered}
...
`);var x=e(m,2);a(x,()=>i`D^{0.5} x^n = \\frac{\\Gamma(n+1)}{\\Gamma(n-\\frac12+1)} x^{n-\\frac12}`);var u=e(x,2);a(u,()=>i`D^{0.5} D^{0.5} x^n = \\frac{\\Gamma(n+1)}{\\Gamma(n-\\frac12+1)} \\cdot \\frac{\\Gamma(n-\\frac12+1)}{\\Gamma(n-1+1)} x^{n-1} = \\frac{\\Gamma(n+1)}{\\Gamma(n-1+1)} x^{n-1} = n x^{n-1} = D x^n.`);var p=e(u,2);a(p,()=>t`D^{0.5} x = \\frac{2}{\\sqrt{\\pi}} \\sqrt{x}`);var r=e(p,2),j=e(L(r));a(j,()=>t`e^{kx}`),V(r);var w=e(r,2);a(w,()=>t`D e^{kx} = k e^{kx}`);var g=e(w,2);a(g,()=>t`D^2 e^{kx} = k^2 e^{kx}`);var _=e(g,2);a(_,()=>t`D^{\\alpha} e^{kx} = k^{\\alpha} e^{kx}`);var k=e(_,2);a(k,()=>t`D^{0.5} e^{kx} = \\sqrt{k} e^{kx}`);var y=e(k,2);a(y,()=>t`D^{0.5}`);var D=e(y,2);a(D,()=>t`D e^{kx}`);var b=e(D,2);a(b,()=>t`k=2, \\alpha=i`);var G=e(b,2);a(G,()=>i`
\\begin{align*}
    D^{i} e^{2x} &= 2^i e^{2x}
    &= e^{i \\ln2} e^{2x}
    &= (\\cos(\\ln2) + i \\sin(\\ln2)) e^{2x}
\\end{align*}
`);var W=e(G,2);a(W,()=>t`D^i e^{ix}`);var S=e(W,2);a(S,()=>t`i^i e^{ix}`);var T=e(S,2);a(T,()=>t`e^{-\\frac{\\pi}{2}} e^{ix}`);var q=e(T,2);a(q,()=>t`\\cos x`);var $=e(q,2);a($,()=>t`\\cos x = \\frac{e^{ix} + e^{-ix}}{2}`);var F=e($,2);a(F,()=>t`D^{\\alpha} \\cos x = \\cos(x + \\frac{\\pi}2 \\alpha)`);var A=e(F,2);a(A,()=>t`D^i x`);var o=e(A,2);a(o,()=>t`D^i x`,!0),V(o);var I=e(o,2);a(I,()=>t`D^i x = \\frac{1}{\\Gamma(2-i)} x^{1 - i}`);var N=e(I,2);a(N,()=>t`\\frac{1}{\\Gamma(2-i)} = \\frac{(i-1)\\sinh(\\pi)}{2\\pi}\\Gamma(i)`);var R=e(N,2);a(R,()=>t`x^{1 - i} = x \\cos (\\ln x) - i x \\sin(\\ln x)`);var z=e(R,2);a(z,()=>i`
    D^i x = \\frac{(i-1)\\sinh(\\pi)}{2\\pi} \\Gamma(i) \\left( x \\cos (\\ln x) - i x \\sin(\\ln x) \\right)
`);var B=e(z,2);ae(B,{title:"Continuous Taylor's Series",children:(s,se)=>{E();var M=re(),O=e(Q(M));a(O,()=>i`
        f(x) = \\sum_{n=0}^{\\infty} \\frac{f^{(n)}(a)}{n!} (x-a)^n
    `);var C=e(O,2);a(C,()=>i`
        f(x) = \\int_0^{\\infty} \\frac{D^t f(a)}{\\Gamma(t+1)} (x-a)^t dt
    `),P(s,M)},$$slots:{default:!0}}),ne(e(B,2),{list:[["Fractional Derivatives (playlist)","https://www.youtube.com/playlist?list=PLJb1qAQIrmmB_ma3YrfuOXTPOQawokYV_"],["Gamma Function","https://en.m.wikipedia.org/wiki/Gamma_function"]]}),P(J,d),Z()}export{ve as component};
