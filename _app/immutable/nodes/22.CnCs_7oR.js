import"../chunks/DsnmJJEf.js";import"../chunks/69_IOA4Y.js";import{p as K,f as P,a as U,g as Z,s as e,d as ee,c as V,r as X,n as ae}from"../chunks/Cc-U2CFn.js";import{a as J,f as Q}from"../chunks/ecw0CP_J.js";import{h as a}from"../chunks/DCtWGmPh.js";import{i as ie}from"../chunks/Bj7q6zUx.js";import{D as te,d as s,_ as t,a as i}from"../chunks/BP9avG_5.js";import{M as ne}from"../chunks/DNjFuzX8.js";import{A as re}from"../chunks/DvSWQ2_a.js";import{R as oe}from"../chunks/MKQfYD7l.js";var se=Q(`The way the Taylor's series is defined in its discrete form is as follows: <!> We can generalize this to a continuous form by replacing the factorial with
...
Giving us <!> Absolute insanity. <!> <!>`,1);function we(Y,j){K(j,!1),ie();var d=de(),f=P(d);ne(f,{title:"Fractional, complex, and complex fractional derivatives",sub:"Recreational Math #003",desc:"Non-integer and other continuous derivatives.",date:"29 June 2025"});var c=e(f,2);{let o=ee(()=>[s("D","Derivative operator"),s("k","Variable positive integer"),s("α","Variable real")]);te(c,{generics:{N:["n"],R:["x","y","z"],fXX:["f"]},get list(){return Z(o)}})}var l=e(c,2);a(l,()=>t`
\\begin{gathered}
\\frac{d^2}{dx^2} f(x) = \\frac{d}{dx} \\left( \\frac{d}{dx} f(x) \\right) \\\\
\\frac{d}{dx} f(x) = \\frac{d^{0.5}}{dx^{0.5}} \\left( \\frac{d^{0.5}}{dx^{0.5}} f(x) \\right)
\\end{gathered}
`);var m=e(l,2);a(m,()=>i`D^k = \\frac{d^k}{dx^k}`);var v=e(m,2);a(v,()=>i`x^n`);var h=e(v,2);a(h,()=>t`
...
`);var B=e(z,2);re(B,{title:"Continuous Taylor's Series",children:(o,fe)=>{ae();var M=se(),O=e(P(M));a(O,()=>t`
        f(x) = \\sum_{n=0}^{\\infty} \\frac{f^{(n)}(a)}{n!} (x-a)^n
    `);var E=e(O,2);a(E,()=>t`
        f(x) = \\int_0^{\\infty} \\frac{D^t f(a)}{\\Gamma(t+1)} (x-a)^t dt
    `),J(o,M)},$$slots:{default:!0}});var L=e(B,2);oe(L,{list:[["Fractional Derivatives (playlist)","https://www.youtube.com/playlist?list=PLJb1qAQIrmmB_ma3YrfuOXTPOQawokYV_"],["Gamma Function","https://en.m.wikipedia.org/wiki/Gamma_function"]]}),J(Y,d),U()}export{we as component};
