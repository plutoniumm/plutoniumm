import{S as Ga,i as Wa,s as Sa,x as In,r as Tn,d as t,H as o,e as F,y as Hn,v as qn,j as r,z as s,f as I,h as T,k as e,A as zn,m as i,n as Bn,t as En,b as Ln,B as Nn,q as Yn,o as Fa}from"../../../../chunks/index-fd6faf80.js";import{_ as $,a as d,M as Ia,D as Ta,d as Vn}from"../../../../chunks/index-b4de6977.js";import{A as Ha}from"../../../../chunks/accord-0e7ebe72.js";import{L as Cn}from"../../../../chunks/link-d240c9a0.js";function qa(y){let f,c,h,u,l,k=$`
    ...
    `),u=new o(!1),l=Yn(),this.h()},l(m){f=r(m,`The way the Taylor's series is defined in its discrete form is as follows:
    ...
    `),u=s(m,!1),l=Yn(),this.h()},h(){c.a=h,u.a=l},m(m,w){i(m,f,w),c.m(k,m,w),i(m,h,w),u.m(b,m,w),i(m,l,w)},p:Fa,d(m){m&&e(f),m&&c.d(),m&&e(h),m&&e(l),m&&u.d()}}}function za(y){let f;return{c(){f=t("Fractional Derivatives (playlist)")},l(c){f=r(c,"Fractional Derivatives (playlist)")},m(c,h){i(c,f,h)},d(c){c&&e(f)}}}function Ba(y){let f;return{c(){f=t("Gamma Function")},l(c){f=r(c,"Gamma Function")},m(c,h){i(c,f,h)},d(c){c&&e(f)}}}function Ea(y){let f,c,h,u,l,k,b,m,w,H,q,z,B,E,L,N,_,A,D,Xn,_n,An,O,R,j,M,V,X,J,P,Q,Y,C,U,K,Z,nn,an,en,tn,rn,on,sn,fn,cn,mn,dn,hn,ln,wn,un,vn,W,On,pn,gn,xn,$n,yn,kn,bn,Dn,v,Rn,S,Jn,jn,p,Gn,g,Pn,Wn,x,Mn,Un=$`
\\frac{d^2}{dx^2} f(x) = \\frac{d}{dx} \\left( \\frac{d}{dx} f(x) \\right) \\\\
\\frac{d}{dx} f(x) = \\frac{d^{0.5}}{dx^{0.5}} \\left( \\frac{d^{0.5}}{dx^{0.5}} f(x) \\right) \\\\
`+"",Kn=d`D^k = \\frac{d^k}{dx^k}`+"",Zn=d`x^n`+"",na=$`
    \\frac{d^k}{dx^k} x^n = D^k x^n  =\\frac{n!}{(n-k)!} x^{n-k} = \\frac{\\Gamma(n+1)}{\\Gamma(n-k+1)} x^{n-k}
`+"",aa=$`D^{0.5} = \\frac{\\Gamma(n+1)}{\\Gamma(n-\\frac12+1)} x^{n-\\frac12}`+"",ea=$`D^{0.5} D^{0.5} x^n = \\frac{\\Gamma(n+1)}{\\Gamma(n-\\frac12+1)} \\cdot \\frac{\\Gamma(n-\\frac12+1)}{\\Gamma(n-1+1)} x^{n-1} = \\frac{\\Gamma(n+1)}{\\Gamma(n-1+1)} x^{n-1} = n x^{n-1} = D x^n.`+"",ia=d`D^{0.5} x = \\frac{2}{\\sqrt{\\pi}} \\sqrt{x}`+"",ta=d`e^{kx}`+"",ra=d`D e^{kx} = k e^{kx}`+"",oa=d`D^2 e^{kx} = k^2 e^{kx}`+"",sa=d`D^{\\alpha} e^{kx} = k^{\\alpha} e^{kx}`+"",fa=d`D^{0.5} e^{kx} = \\sqrt{k} e^{kx}`+"",ca=d`D^{0.5}`+"",ma=d`D e^{kx}`+"",da=d`k=2, \\alpha=i`+"",ha=$`
\\begin{align*}
    D^{i} e^{2x} &= 2^i e^{2x}
    &= e^{i \\ln2} e^{2x}
    &= (\\cos(\\ln2) + i \\sin(\\ln2)) e^{2x}
\\end{align*}
`+"",la=d`D^i e^{ix}`+"",wa=d`i^i e^{ix}`+"",ua=d`e^{-\\frac{\\pi}{2}} e^{ix}`+"",va=d`\\cos x`+"",pa=d`\\cos x = \\frac{e^{ix} + e^{-ix}}{2}`+"",ga=d`D^{\\alpha} \\cos x = \\cos x + \\frac{\\pi}2 \\alpha`+"",xa=d`D^i x`+"",$a=d`D^i x`+"",ya=d`D^i x = \\frac{1}{\\Gamma(2-i)} x^{1 - i}`+"",ka=d`\\frac{1}{\\Gamma(2-i)} = \\frac{i-1}{2\\pi}\\Gamma(i)`+"",ba=d`x^{1 - i} = x \\cos (\\ln x) + i x \\sin(\\ln x)`+"",Da=$`
    D^i x = \\frac{i-1}{2\\pi} \\Gamma(i) \\left( x \\cos (\\ln x) + i x \\sin(\\ln x) \\right)
`+"";return f=new Ia({props:{title:"Fractional, complex, and fractional complex derivatives",sub:"Recreational Math #003",desc:"Non-integer and other continuous derivatives.",date:"29 June 2025"}}),h=new Ta({props:{generics:{N:["n"],R:["x","y","z"],fXX:["f"]},list:[Vn("D","Derivative operator"),Vn("k","Variable positive integer"),Vn("α","Variable real"),Vn("Γ","Gamma function","wikipedia")]}}),v=new Ha({props:{title:"Continuous Taylor's Series",$$slots:{default:[qa]},$$scope:{ctx:y}}}),g=new Cn({props:{href:"https://www.youtube.com/playlist?list=PLJb1qAQIrmmB_ma3YrfuOXTPOQawokYV_",$$slots:{default:[za]},$$scope:{ctx:y}}}),x=new Cn({props:{href:"https://en.m.wikipedia.org/wiki/Gamma_function",$$slots:{default:[Ba]},$$scope:{ctx:y}}}),{c(){In(f.$$.fragment),c=Tn(),In(h.$$.fragment),u=t(`
...
want a the derivative of say `),cn=new o(!1),mn=t(", we can represent "),dn=new o(!1),hn=t(`
and then proceed from there. One can verify that `),ln=new o(!1),wn=t(`.
...
`),In(v.$$.fragment),Rn=Tn(),S=F("h4"),Jn=t("References"),jn=Tn(),p=F("ul"),Gn=F("li"),In(g.$$.fragment),Pn=Tn(),Wn=F("li"),In(x.$$.fragment),this.h()},l(n){Hn(f.$$.fragment,n),c=qn(n),Hn(h.$$.fragment,n),u=r(n,`
...
a complex function, we got a real coefficient. In general, we can safely say
that non-integer derivatives may give us a real or complex result. Now if we
want a the derivative of say `),cn=s(n,!1),mn=r(n,", we can represent "),dn=s(n,!1),hn=r(n,`
and then proceed from there. One can verify that `),ln=s(n,!1),wn=r(n,`.
So, the differential operator is simply a shifting operator for the sinusoidal
function. But now that we've asked the question of an imaginary derivative, we
...
`),Hn(v.$$.fragment,n),Rn=qn(n),S=I(n,"H4",{});var Sn=T(S);Jn=r(Sn,"References"),Sn.forEach(e),jn=qn(n),p=I(n,"UL",{});var G=T(p);Gn=I(G,"LI",{});var Fn=T(Gn);Hn(g.$$.fragment,Fn),Fn.forEach(e),Pn=qn(G),Wn=I(G,"LI",{});var Qn=T(Wn);Hn(x.$$.fragment,Qn),Qn.forEach(e),G.forEach(e),this.h()},h(){l.a=k,b.a=m,w.a=H,q.a=z,B.a=E,L.a=N,_.a=A,_n.a=null,O.a=R,j.a=M,V.a=X,J.a=P,Q.a=Y,C.a=U,K.a=Z,nn.a=an,en.a=tn,rn.a=on,sn.a=fn,cn.a=mn,dn.a=hn,ln.a=wn,un.a=vn,pn.a=gn,xn.a=$n,yn.a=kn,bn.a=Dn},m(n,a){zn(f,n,a),i(n,c,a),zn(h,n,a),i(n,u,a),l.m(Un,n,a),i(n,k,a),b.m(Kn,n,a),i(n,m,a),w.m(Zn,n,a),i(n,H,a),q.m(na,n,a),i(n,z,a),B.m(aa,n,a),i(n,E,a),L.m(ea,n,a),i(n,N,a),_.m(ia,n,a),i(n,A,a),i(n,D,a),Bn(D,Xn),_n.m(ta,D),i(n,An,a),O.m(ra,n,a),i(n,R,a),j.m(oa,n,a),i(n,M,a),V.m(sa,n,a),i(n,X,a),J.m(fa,n,a),i(n,P,a),Q.m(ca,n,a),i(n,Y,a),C.m(ma,n,a),i(n,U,a),K.m(da,n,a),i(n,Z,a),nn.m(ha,n,a),i(n,an,a),en.m(la,n,a),i(n,tn,a),rn.m(wa,n,a),i(n,on,a),sn.m(ua,n,a),i(n,fn,a),cn.m(va,n,a),i(n,mn,a),dn.m(pa,n,a),i(n,hn,a),ln.m(ga,n,a),i(n,wn,a),un.m(xa,n,a),i(n,vn,a),i(n,W,a),W.innerHTML=$a,i(n,On,a),pn.m(ya,n,a),i(n,gn,a),xn.m(ka,n,a),i(n,$n,a),yn.m(ba,n,a),i(n,kn,a),bn.m(Da,n,a),i(n,Dn,a),zn(v,n,a),i(n,Rn,a),i(n,S,a),Bn(S,Jn),i(n,jn,a),i(n,p,a),Bn(p,Gn),zn(g,Gn,null),Bn(p,Pn),Bn(p,Wn),zn(x,Wn,null),Mn=!0},p(n,[a]){const Sn={};1&a&&(Sn.$$scope={dirty:a,ctx:n}),v.$set(Sn);const G={};1&a&&(G.$$scope={dirty:a,ctx:n}),g.$set(G);const Fn={};1&a&&(Fn.$$scope={dirty:a,ctx:n}),x.$set(Fn)},i(n){Mn||(En(f.$$.fragment,n),En(h.$$.fragment,n),En(v.$$.fragment,n),En(g.$$.fragment,n),En(x.$$.fragment,n),Mn=!0)},o(n){Ln(f.$$.fragment,n),Ln(h.$$.fragment,n),Ln(v.$$.fragment,n),Ln(g.$$.fragment,n),Ln(x.$$.fragment,n),Mn=!1},d(n){Nn(f,n),n&&e(c),Nn(h,n),n&&e(u),n&&l.d(),n&&e(k),n&&b.d(),n&&e(m),n&&w.d(),n&&e(H),n&&q.d(),n&&e(z),n&&B.d(),n&&e(E),n&&L.d(),n&&e(N),n&&_.d(),n&&e(A),n&&e(D),n&&e(An),n&&O.d(),n&&e(R),n&&j.d(),n&&e(M),n&&V.d(),n&&e(X),n&&J.d(),n&&e(P),n&&Q.d(),n&&e(Y),n&&C.d(),n&&e(U),n&&K.d(),n&&e(Z),n&&nn.d(),n&&e(an),n&&en.d(),n&&e(tn),n&&rn.d(),n&&e(on),n&&sn.d(),n&&e(fn),n&&cn.d(),n&&e(mn),n&&dn.d(),n&&e(hn),n&&ln.d(),n&&e(wn),n&&un.d(),n&&e(vn),n&&e(W),n&&e(On),n&&pn.d(),n&&e(gn),n&&xn.d(),n&&e($n),n&&yn.d(),n&&e(kn),n&&bn.d(),n&&e(Dn),Nn(v,n),n&&e(Rn),n&&e(S),n&&e(jn),n&&e(p),Nn(g),Nn(x)}}}class Oa extends Ga{constructor(f){super(),Wa(this,f,null,Ea,Sa,{})}}export{Oa as default};
