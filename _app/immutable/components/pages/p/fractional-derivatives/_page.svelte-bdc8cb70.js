import{S as ha,i as la,s as wa,x as $n,r as In,d as t,H as o,e as Hn,y as bn,v as qn,j as r,z as s,f as Nn,h as _n,k as e,A as Dn,m as i,n as ua,t as Wn,b as Gn,B as Sn,q as An,o as va}from"../../../../chunks/index-50297438.js";import{_ as p,a as c,M as pa,D as ga,d as zn}from"../../../../chunks/index-b34ad718.js";import{A as xa}from"../../../../chunks/accord-8d900bd5.js";import{R as ya}from"../../../../chunks/refs-aae19ce2.js";function ka(Tn){let m,w,d,u,h,g=p`
    ...
    `),u=s(f,!1),h=An(),this.h()},h(){w.a=d,u.a=h},m(f,l){i(f,m,l),w.m(g,f,l),i(f,d,l),u.m(x,f,l),i(f,h,l)},p:va,d(f){f&&e(m),f&&w.d(),f&&e(d),f&&e(h),f&&u.d()}}}function $a(Tn){let m,w,d,u,h,g,x,f,l,b,D,W,G,S,T,F,I,q,y,Fn,pn,gn,z,B,H,N,_,A,j,O,M,R,V,X,E,J,L,P,Q,Y,C,K,U,Z,nn,an,en,tn,rn,on,sn,fn,$,xn,cn,mn,dn,hn,ln,wn,un,vn,v,yn,k,kn,jn=p`
\\frac{d^2}{dx^2} f(x) = \\frac{d}{dx} \\left( \\frac{d}{dx} f(x) \\right) \\\\
\\frac{d}{dx} f(x) = \\frac{d^{0.5}}{dx^{0.5}} \\left( \\frac{d^{0.5}}{dx^{0.5}} f(x) \\right) \\\\
`+"",On=c`D^k = \\frac{d^k}{dx^k}`+"",Mn=c`x^n`+"",Rn=p`
...
So one can then see that `),I=new o(!1),q=t(`. This
...
`),$n(v.$$.fragment),yn=In(),$n(k.$$.fragment),this.h()},l(n){bn(m.$$.fragment,n),w=qn(n),bn(d.$$.fragment,n),u=r(n,`
...
So one can then see that `),I=s(n,!1),q=r(n,`. This
also tells us that we can generalize the derivative operator to arbitrary real
numbers, not just integers. We can even use imaginary numbers, but that's a much
different conversation.

`),y=Nn(n,"H3",{});var a=_n(y);Fn=r(a,"Derivatives of "),pn=s(a,!1),a.forEach(e),gn=r(n,`
We know the basic ones like `),z=s(n,!1),B=r(n,` and
`),H=s(n,!1),N=r(n,`. From the pattern, we would expect that
`),_=s(n,!1),A=r(n,", which would imply "),j=s(n,!1),O=r(n,`.
It is trivial to see, if we apply `),M=s(n,!1),R=r(n," twice, we get "),V=s(n,!1),X=r(n,`
back. So then what happens if we feed in `),E=s(n,!1),J=qn(n),L=s(n,!1),P=r(n,`
...
`),bn(v.$$.fragment,n),yn=qn(n),bn(k.$$.fragment,n),this.h()},h(){h.a=g,x.a=f,l.a=b,D.a=W,G.a=S,T.a=F,I.a=q,pn.a=null,z.a=B,H.a=N,_.a=A,j.a=O,M.a=R,V.a=X,E.a=J,L.a=P,Q.a=Y,C.a=K,U.a=Z,nn.a=an,en.a=tn,rn.a=on,sn.a=fn,cn.a=mn,dn.a=hn,ln.a=wn,un.a=vn},m(n,a){Dn(m,n,a),i(n,w,a),Dn(d,n,a),i(n,u,a),h.m(jn,n,a),i(n,g,a),x.m(On,n,a),i(n,f,a),l.m(Mn,n,a),i(n,b,a),D.m(Rn,n,a),i(n,W,a),G.m(Vn,n,a),i(n,S,a),T.m(Xn,n,a),i(n,F,a),I.m(En,n,a),i(n,q,a),i(n,y,a),ua(y,Fn),pn.m(Jn,y),i(n,gn,a),z.m(Ln,n,a),i(n,B,a),H.m(Pn,n,a),i(n,N,a),_.m(Qn,n,a),i(n,A,a),j.m(Yn,n,a),i(n,O,a),M.m(Cn,n,a),i(n,R,a),V.m(Kn,n,a),i(n,X,a),E.m(Un,n,a),i(n,J,a),L.m(Zn,n,a),i(n,P,a),Q.m(na,n,a),i(n,Y,a),C.m(aa,n,a),i(n,K,a),U.m(ea,n,a),i(n,Z,a),nn.m(ia,n,a),i(n,an,a),en.m(ta,n,a),i(n,tn,a),rn.m(ra,n,a),i(n,on,a),sn.m(oa,n,a),i(n,fn,a),i(n,$,a),$.innerHTML=sa,i(n,xn,a),cn.m(fa,n,a),i(n,mn,a),dn.m(ca,n,a),i(n,hn,a),ln.m(ma,n,a),i(n,wn,a),un.m(da,n,a),i(n,vn,a),Dn(v,n,a),i(n,yn,a),Dn(k,n,a),kn=!0},p(n,[a]){const Bn={};1&a&&(Bn.$$scope={dirty:a,ctx:n}),v.$set(Bn)},i(n){kn||(Wn(m.$$.fragment,n),Wn(d.$$.fragment,n),Wn(v.$$.fragment,n),Wn(k.$$.fragment,n),kn=!0)},o(n){Gn(m.$$.fragment,n),Gn(d.$$.fragment,n),Gn(v.$$.fragment,n),Gn(k.$$.fragment,n),kn=!1},d(n){Sn(m,n),n&&e(w),Sn(d,n),n&&e(u),n&&h.d(),n&&e(g),n&&x.d(),n&&e(f),n&&l.d(),n&&e(b),n&&D.d(),n&&e(W),n&&G.d(),n&&e(S),n&&T.d(),n&&e(F),n&&I.d(),n&&e(q),n&&e(y),n&&e(gn),n&&z.d(),n&&e(B),n&&H.d(),n&&e(N),n&&_.d(),n&&e(A),n&&j.d(),n&&e(O),n&&M.d(),n&&e(R),n&&V.d(),n&&e(X),n&&E.d(),n&&e(J),n&&L.d(),n&&e(P),n&&Q.d(),n&&e(Y),n&&C.d(),n&&e(K),n&&U.d(),n&&e(Z),n&&nn.d(),n&&e(an),n&&en.d(),n&&e(tn),n&&rn.d(),n&&e(on),n&&sn.d(),n&&e(fn),n&&e($),n&&e(xn),n&&cn.d(),n&&e(mn),n&&dn.d(),n&&e(hn),n&&ln.d(),n&&e(wn),n&&un.d(),n&&e(vn),Sn(v,n),n&&e(yn),Sn(k,n)}}}class Sa extends ha{constructor(m){super(),la(this,m,null,$a,wa,{})}}export{Sa as default};
