import{S as he,i as le,s as de,e as N,C as U,f as F,h as q,D as J,k as e,l as v,m as a,n as C,o as zt,p as Pt,d as i,j as h,w as Qt,H as g,r as R,z as p,v as _,x as A,y as H,A as M,t as O,b as z,B as D}from"../../../../chunks/index-74fbc9f8.js";import{A as Ge}from"../../../../chunks/accord-5b8d583e.js";import{_ as Ot,a as k,M as Ue}from"../../../../chunks/meta-846f439e.js";import{L as Je}from"../../../../chunks/link-f469bc16.js";function te(b,r,d){const l=b.slice();return l[5]=r[d],l[7]=d,l}function ee(b,r,d){const l=b.slice();return l[5]=r[d],l[7]=d,l}function ae(b,r,d){const l=b.slice();return l[9]=r[d],l[7]=d,l}function se(b){let r,d,l=b[9]+"";return{c(){r=U("tspan"),d=i(l),this.h()},l(c){r=J(c,"tspan",{x:!0,y:!0});var w=q(r);d=h(w,l),w.forEach(e),this.h()},h(){v(r,"x",15+30*b[7]),v(r,"y","25")},m(c,w){a(c,r,w),C(r,d)},p(c,w){2&w&&l!==(l=c[9]+"")&&Qt(d,l)},d(c){c&&e(r)}}}function re(b){let r,d;return{c(){r=U("tspan"),d=i("―"),this.h()},l(l){r=J(l,"tspan",{x:!0,y:!0});var c=q(r);d=h(c,"―"),c.forEach(e),this.h()},h(){v(r,"x",10+30*b[7]),v(r,"y","45")},m(l,c){a(l,r,c),C(r,d)},p:zt,d(l){l&&e(r)}}}function oe(b){let r,d,l,c,w,T,y,f,W,x,E=b[1].length-b[7]+"",$=b[1].length-b[7]-b[2]+"";return{c(){r=U("tspan"),d=i("("),l=new g(!0),c=i(")"),w=U("sup"),T=i(E),y=R(),f=U("tspan"),W=i($),this.h()},l(s){r=J(s,"tspan",{x:!0,y:!0});var u=q(r);d=h(u,"("),l=p(u,!0),c=h(u,")"),w=J(u,"sup",{});var o=q(w);T=h(o,E),o.forEach(e),u.forEach(e),y=_(s),f=J(s,"tspan",{x:!0,y:!0});var B=q(f);W=h(B,$),B.forEach(e),this.h()},h(){l.a=c,v(r,"x",10+30*b[7]),v(r,"y","65"),v(f,"x",x=b[3]+30*b[7]),v(f,"y","60")},m(s,u){a(s,r,u),C(r,d),l.m(b[0],r),C(r,c),C(r,w),C(w,T),a(s,y,u),a(s,f,u),C(f,W)},p(s,u){1&u&&l.p(s[0]),2&u&&E!==(E=s[1].length-s[7]+"")&&Qt(T,E),6&u&&$!==($=s[1].length-s[7]-s[2]+"")&&Qt(W,$),8&u&&x!==(x=s[3]+30*s[7])&&v(f,"x",x)},d(s){s&&e(r),s&&e(y),s&&e(f)}}}function Pe(b){let r,d,l,c,w,T,y=b[1],f=[];for(let s=0;s<y.length;s+=1)f[s]=se(ae(b,y,s));let W=b[1],x=[];for(let s=0;s<W.length;s+=1)x[s]=re(ee(b,W,s));let E=b[1],$=[];for(let s=0;s<E.length;s+=1)$[s]=oe(te(b,E,s));return{c(){r=N("p"),d=U("svg"),l=U("text");for(let s=0;s<f.length;s+=1)f[s].c();c=U("text");for(let s=0;s<x.length;s+=1)x[s].c();w=U("text");for(let s=0;s<$.length;s+=1)$[s].c();this.h()},l(s){r=F(s,"P",{class:!0});var u=q(r);d=J(u,"svg",{width:!0,height:!0,"font-family":!0,"font-weight":!0,"font-size":!0});var o=q(d);l=J(o,"text",{x:!0,y:!0});var B=q(l);for(let S=0;S<f.length;S+=1)f[S].l(B);B.forEach(e),c=J(o,"text",{x:!0,y:!0});var j=q(c);for(let S=0;S<x.length;S+=1)x[S].l(j);j.forEach(e),w=J(o,"text",{x:!0,y:!0,"font-size":!0});var L=q(w);for(let S=0;S<$.length;S+=1)$[S].l(L);L.forEach(e),o.forEach(e),u.forEach(e),this.h()},h(){v(l,"x","10"),v(l,"y","20"),v(c,"x","10"),v(c,"y","45"),v(w,"x","10"),v(w,"y","70"),v(w,"font-size","12"),v(d,"width",T=15+30*b[1].length),v(d,"height","80"),v(d,"font-family","sans-serif"),v(d,"font-weight","300"),v(d,"font-size","24"),v(r,"class","w-100 tc")},m(s,u){a(s,r,u),C(r,d),C(d,l);for(let o=0;o<f.length;o+=1)f[o].m(l,null);C(d,c);for(let o=0;o<x.length;o+=1)x[o].m(c,null);C(d,w);for(let o=0;o<$.length;o+=1)$[o].m(w,null)},p(s,[u]){if(2&u){let o;for(y=s[1],o=0;o<y.length;o+=1){const B=ae(s,y,o);f[o]?f[o].p(B,u):(f[o]=se(B),f[o].c(),f[o].m(l,null))}for(;o<f.length;o+=1)f[o].d(1);f.length=y.length}if(2&u){let o;for(W=s[1],o=0;o<W.length;o+=1){const B=ee(s,W,o);x[o]?x[o].p(B,u):(x[o]=re(B),x[o].c(),x[o].m(c,null))}for(;o<x.length;o+=1)x[o].d(1);x.length=W.length}if(15&u){let o;for(E=s[1],o=0;o<E.length;o+=1){const B=te(s,E,o);$[o]?$[o].p(B,u):($[o]=oe(B),$[o].c(),$[o].m(w,null))}for(;o<$.length;o+=1)$[o].d(1);$.length=E.length}2&u&&T!==(T=15+30*s[1].length)&&v(d,"width",T)},i:zt,o:zt,d(s){s&&e(r),Pt(f,s),Pt(x,s),Pt($,s)}}}function Qe(b,r,d){let{top:l=[]}=r,{base:c=10}=r,{base_str:w}=r;if(typeof c!="number")throw new Error("Base must be a number");let T=1;l.includes(".")&&(T=l.length-l.indexOf("."));let y=30;return c<=9&&c>=2&&c%1==0&&(y=24),w||(w=c.toString()),b.$$set=f=>{"top"in f&&d(1,l=f.top),"base"in f&&d(4,c=f.base),"base_str"in f&&d(0,w=f.base_str)},[w,l,T,y,c]}class G extends he{constructor(r){super(),le(this,r,Qe,Pe,de,{top:1,base:4,base_str:0})}}function Ve(b){let r,d,l,c,w,T,y,f,W,x,E,$,s,u,o,B,j=Ot`
  \\begin{align*}
    31 \\div 2 &= 15\\ &r\\ 1\\\\
    15 \\div 2 &= 7\\ &r\\ 1\\\\
    7 \\div 2 &= 3\\ &r\\ 1\\\\
    ...
    0.5 \\times 2 &= 1.0\\ &r\\ 1\\\\
  \\end{align*}
  `+"",L=k`\\frac1n`+"",S=k`b`+"",hn=k`|b|-1`+"",nn=k`\\frac1b`+"";return c=new G({props:{top:[1,1,1,1,".",0,0,1],base:2}}),f=new G({props:{top:[1,0,0,1,".",1,1,1],base:.5,base_str:"½"}}),{c(){r=i(`Consider the number first in base 10: 31.125. We will follow the process to
    ...
    base `),u=p(m,!1),o=h(m," also we can do the same."),this.h()},h(){d.a=l,T.a=y,x.a=E,$.a=s,u.a=o},m(m,I){a(m,r,I),d.m(j,m,I),a(m,l,I),M(c,m,I),a(m,w,I),T.m(L,m,I),a(m,y,I),M(f,m,I),a(m,W,I),x.m(S,m,I),a(m,E,I),$.m(hn,m,I),a(m,s,I),u.m(nn,m,I),a(m,o,I),B=!0},p:zt,i(m){B||(O(c.$$.fragment,m),O(f.$$.fragment,m),B=!0)},o(m){z(c.$$.fragment,m),z(f.$$.fragment,m),B=!1},d(m){m&&e(r),m&&d.d(),m&&e(l),D(c,m),m&&e(w),m&&T.d(),m&&e(y),D(f,m),m&&e(W),m&&x.d(),m&&e(E),m&&$.d(),m&&e(s),m&&u.d(),m&&e(o)}}}function Ke(b){let r;return{c(){r=i("Can any Number be a Base? (video)")},l(d){r=h(d,"Can any Number be a Base? (video)")},m(d,l){a(d,r,l)},d(d){d&&e(r)}}}function Xe(b){let r,d,l,c,w,T,y,f,W,x,E,$,s,u,o,B,j,L,S,hn,nn,m,I,ln,dn,mn,cn,bn,fn,V,pt,wn,un,gn,pn,tn,Dt,yt,yn,vn,$n,xn,Tn,En,Wn,Bn,K,vt,kn,qn,In,Sn,P,$t,Cn,Nn,Fn,Rn,_n,jn,An,Hn,Mn,On,xt,Tt,Et,Wt,zn,Dn,en,Lt,Bt,Ln,Gn,kt,qt,X,It,Y,St,Un,Jn,Ct,Nt,Ft,Rt,Pn,Qn,Vn,Kn,Xn,Yn,Zn,nt,tt,et,at,st,an,Gt,_t,rt,ot,it,ht,lt,dt,sn,Ut,jt,mt,ct,Z,At,bt,ft,rn,Jt,Ht,on,wt,Q,Mt,me=b[0]([4,2,0],10,"")+"",ce=b[0]([1,1,0,1,0,0,1,0,0],2,"")+"",be=Ot`
\\begin{align*}
	420 \\div 2 &= 210\\ &r\\ 0\\\\
	210 \\div 2 &= 105\\ &r\\ 0\\\\
	105 \\div 2 &= 52\\ &r\\ 1\\\\
...
`),A(j.$$.fragment),L=R(),S=N("h3"),hn=i("Base Conversion"),nn=i(`
...
`),tn=N("h3"),Dt=i("Rational Bases"),yt=i(`
...
`),A(K.$$.fragment),vt=i(`
The above number is read as `),kn=new g(!1),qn=i(`. This
...
i.e. `),In=new g(!1),Sn=i(`, we can even flip around the traditional positive power
numbers around the decimal point.

`),A(P.$$.fragment),$t=i(`

Now, what if we were to consider arbitrary rational bases rather than just those
which are of the form `),Cn=new g(!1),Nn=i("? So, say how we write 265 in base "),Fn=new g(!1),Rn=i(`.
...
`),en=N("h3"),Lt=i("Irrational and Transcendental Bases"),Bt=i(`
The easiest to start with is an 'nth' root base, such as `),Ln=new g(!1),Gn=i(`. This
should be related to being in base 5. So consider 42 in base 5, or `),kt=i(Vt),qt=i(` in base 10. We can very easily first write

`),A(X.$$.fragment),It=R(),A(Y.$$.fragment),St=i(`
...
`),an=N("h3"),Gt=i("Removing Constraints"),_t=i(`
...
number as long as we do the place value algebra for it correctly `),lt=new g(!1),dt=R(),sn=N("h3"),Ut=i("Going further"),jt=i(`
...
`),A(Z.$$.fragment),At=R(),bt=new g(!1),ft=R(),rn=N("h4"),Jt=i("References"),Ht=R(),on=N("ul"),wt=N("li"),A(Q.$$.fragment),this.h()},l(n){H(r.$$.fragment,n),d=_(n),l=F(n,"DEFINE",{key:!0,type:!0,content:!0}),q(l).forEach(e),c=_(n),w=F(n,"DEFINE",{key:!0,type:!0,content:!0}),q(w).forEach(e),T=_(n),y=F(n,"DEFINE",{key:!0,type:!0,content:!0}),q(y).forEach(e),f=_(n),W=F(n,"DEFINE",{key:!0,type:!0,content:!0}),q(W).forEach(e),x=h(n,`
...
`),H(j.$$.fragment,n),L=_(n),S=F(n,"H3",{});var t=q(S);hn=h(t,"Base Conversion"),t.forEach(e),nn=h(n,`
To convert from base 10 to base 2, divide by 2 repeatedly and record the remainder.
...
`),tn=F(n,"H3",{});var ut=q(tn);Dt=h(ut,"Rational Bases"),ut.forEach(e),yt=h(n,`
...
The above number is read as `),kn=p(n,!1),qn=h(n,`. This
time, we can see we're not only allowed addition but also subtraction depending
upon which order-of-magnitude place we're in. Negative numbers can be taken one
step forward with rational powers (say <1). If we use single-part fractions,
i.e. `),In=p(n,!1),Sn=h(n,`, we can even flip around the traditional positive power
numbers around the decimal point.

`),H(P.$$.fragment,n),$t=h(n,`

Now, what if we were to consider arbitrary rational bases rather than just those
which are of the form `),Cn=p(n,!1),Nn=h(n,"? So, say how we write 265 in base "),Fn=p(n,!1),Rn=h(n,`.
...
`),en=F(n,"H3",{});var gt=q(en);Lt=h(gt,"Irrational and Transcendental Bases"),gt.forEach(e),Bt=h(n,`
The easiest to start with is an 'nth' root base, such as `),Ln=p(n,!1),Gn=h(n,`. This
should be related to being in base 5. So consider 42 in base 5, or `),kt=h(n,Vt),qt=h(n,` in base 10. We can very easily first write

`),H(X.$$.fragment,n),It=_(n),H(Y.$$.fragment,n),St=h(n,`

We can see both the above representations are functionally equivalent , with
extra place values added in the 'gaps' between the integer place values. It
should be trivial to see that `),Un=p(n,!1),Jn=h(n,` are the standard place values
when we use five as our base.
`),Ct=F(n,"BR",{}),Nt=_(n),Ft=F(n,"BR",{}),Rt=h(n,`
...
`),an=F(n,"H3",{});var Kt=q(an);Gt=h(Kt,"Removing Constraints"),Kt.forEach(e),_t=h(n,`
So far, above, we set some very arbitrary rules on what digits we can use for what
base. In reality, however, those are the standard preferences for the given bases,
There don't exist any constraints on what base we can use. Consider using the symbols
...
actually no limits to what digit we choose every step. '79A45' is a valid base 2
number as long as we do the place value algebra for it correctly `),lt=p(n,!1),dt=_(n),sn=F(n,"H3",{});var Xt=q(sn);Ut=h(Xt,"Going further"),Xt.forEach(e),jt=h(n,`
Not only can transcendental numbers be bases, so can complex numbers be. Consider
a cube root of unity, `),mt=p(n,!1),ct=h(n,`. So a simple
number like 1234 would be

`),H(Z.$$.fragment,n),At=_(n),bt=p(n,!1),ft=_(n),rn=F(n,"H4",{});var Yt=q(rn);Jt=h(Yt,"References"),Yt.forEach(e),Ht=_(n),on=F(n,"UL",{});var Zt=q(on);wt=F(Zt,"LI",{});var ne=q(wt);H(Q.$$.fragment,ne),ne.forEach(e),Zt.forEach(e),this.h()},h(){v(l,"key","n"),v(l,"type","text"),v(l,"content","Variable. Usually positive integer"),v(w,"key","r"),v(w,"type","text"),v(w,"content","Remainder. Usually < divisor base"),v(y,"key","b"),v(y,"type","text"),v(y,"content","Base of number system"),v(W,"key","ω"),v(W,"type","wikipedia"),v(W,"content","Root_of_unity"),s.a=u,o.a=B,m.a=I,ln.a=dn,mn.a=cn,bn.a=fn,wn.a=un,gn.a=pn,yn.a=vn,$n.a=xn,Tn.a=En,Wn.a=Bn,kn.a=qn,In.a=Sn,Cn.a=Nn,Fn.a=Rn,_n.a=jn,An.a=Hn,Mn.a=On,zn.a=Dn,Ln.a=Gn,Un.a=Jn,Pn.a=Qn,Vn.a=Kn,Xn.a=Yn,Zn.a=nt,tt.a=et,at.a=st,rt.a=ot,it.a=ht,lt.a=dt,mt.a=ct,bt.a=ft},m(n,t){M(r,n,t),a(n,d,t),a(n,l,t),a(n,c,t),a(n,w,t),a(n,T,t),a(n,y,t),a(n,f,t),a(n,W,t),a(n,x,t),M(E,n,t),a(n,$,t),s.m(me,n,t),a(n,u,t),o.m(ce,n,t),a(n,B,t),M(j,n,t),a(n,L,t),a(n,S,t),C(S,hn),a(n,nn,t),m.m(be,n,t),a(n,I,t),ln.m(fe,n,t),a(n,dn,t),mn.m(we,n,t),a(n,cn,t),bn.m(ue,n,t),a(n,fn,t),M(V,n,t),a(n,pt,t),wn.m(ge,n,t),a(n,un,t),gn.m(pe,n,t),a(n,pn,t),a(n,tn,t),C(tn,Dt),a(n,yt,t),yn.m(ye,n,t),a(n,vn,t),$n.m(ve,n,t),a(n,xn,t),Tn.m($e,n,t),a(n,En,t),Wn.m(xe,n,t),a(n,Bn,t),M(K,n,t),a(n,vt,t),kn.m(Te,n,t),a(n,qn,t),In.m(Ee,n,t),a(n,Sn,t),M(P,n,t),a(n,$t,t),Cn.m(We,n,t),a(n,Nn,t),Fn.m(Be,n,t),a(n,Rn,t),_n.m(ke,n,t),a(n,jn,t),An.m(qe,n,t),a(n,Hn,t),Mn.m(Ie,n,t),a(n,On,t),a(n,xt,t),a(n,Tt,t),a(n,Et,t),a(n,Wt,t),zn.m(Se,n,t),a(n,Dn,t),a(n,en,t),C(en,Lt),a(n,Bt,t),Ln.m(Ce,n,t),a(n,Gn,t),a(n,kt,t),a(n,qt,t),M(X,n,t),a(n,It,t),M(Y,n,t),a(n,St,t),Un.m(Ne,n,t),a(n,Jn,t),a(n,Ct,t),a(n,Nt,t),a(n,Ft,t),a(n,Rt,t),Pn.m(Fe,n,t),a(n,Qn,t),Vn.m(Re,n,t),a(n,Kn,t),Xn.m(_e,n,t),a(n,Yn,t),Zn.m(je,n,t),a(n,nt,t),tt.m(Ae,n,t),a(n,et,t),at.m(He,n,t),a(n,st,t),a(n,an,t),C(an,Gt),a(n,_t,t),rt.m(Me,n,t),a(n,ot,t),it.m(Oe,n,t),a(n,ht,t),lt.m(ze,n,t),a(n,dt,t),a(n,sn,t),C(sn,Ut),a(n,jt,t),mt.m(De,n,t),a(n,ct,t),M(Z,n,t),a(n,At,t),bt.m(Le,n,t),a(n,ft,t),a(n,rn,t),C(rn,Jt),a(n,Ht,t),a(n,on,t),C(on,wt),M(Q,wt,null),Mt=!0},p(n,[t]){const ut={};2&t&&(ut.$$scope={dirty:t,ctx:n}),P.$set(ut);const gt={};2&t&&(gt.$$scope={dirty:t,ctx:n}),Q.$set(gt)},i(n){Mt||(O(r.$$.fragment,n),O(E.$$.fragment,n),O(j.$$.fragment,n),O(V.$$.fragment,n),O(K.$$.fragment,n),O(P.$$.fragment,n),O(X.$$.fragment,n),O(Y.$$.fragment,n),O(Z.$$.fragment,n),O(Q.$$.fragment,n),Mt=!0)},o(n){z(r.$$.fragment,n),z(E.$$.fragment,n),z(j.$$.fragment,n),z(V.$$.fragment,n),z(K.$$.fragment,n),z(P.$$.fragment,n),z(X.$$.fragment,n),z(Y.$$.fragment,n),z(Z.$$.fragment,n),z(Q.$$.fragment,n),Mt=!1},d(n){D(r,n),n&&e(d),n&&e(l),n&&e(c),n&&e(w),n&&e(T),n&&e(y),n&&e(f),n&&e(W),n&&e(x),D(E,n),n&&e($),n&&s.d(),n&&e(u),n&&o.d(),n&&e(B),D(j,n),n&&e(L),n&&e(S),n&&e(nn),n&&m.d(),n&&e(I),n&&ln.d(),n&&e(dn),n&&mn.d(),n&&e(cn),n&&bn.d(),n&&e(fn),D(V,n),n&&e(pt),n&&wn.d(),n&&e(un),n&&gn.d(),n&&e(pn),n&&e(tn),n&&e(yt),n&&yn.d(),n&&e(vn),n&&$n.d(),n&&e(xn),n&&Tn.d(),n&&e(En),n&&Wn.d(),n&&e(Bn),D(K,n),n&&e(vt),n&&kn.d(),n&&e(qn),n&&In.d(),n&&e(Sn),D(P,n),n&&e($t),n&&Cn.d(),n&&e(Nn),n&&Fn.d(),n&&e(Rn),n&&_n.d(),n&&e(jn),n&&An.d(),n&&e(Hn),n&&Mn.d(),n&&e(On),n&&e(xt),n&&e(Tt),n&&e(Et),n&&e(Wt),n&&zn.d(),n&&e(Dn),n&&e(en),n&&e(Bt),n&&Ln.d(),n&&e(Gn),n&&e(kt),n&&e(qt),D(X,n),n&&e(It),D(Y,n),n&&e(St),n&&Un.d(),n&&e(Jn),n&&e(Ct),n&&e(Nt),n&&e(Ft),n&&e(Rt),n&&Pn.d(),n&&e(Qn),n&&Vn.d(),n&&e(Kn),n&&Xn.d(),n&&e(Yn),n&&Zn.d(),n&&e(nt),n&&tt.d(),n&&e(et),n&&at.d(),n&&e(st),n&&e(an),n&&e(_t),n&&rt.d(),n&&e(ot),n&&it.d(),n&&e(ht),n&&lt.d(),n&&e(dt),n&&e(sn),n&&e(jt),n&&mt.d(),n&&e(ct),D(Z,n),n&&e(At),n&&bt.d(),n&&e(ft),n&&e(rn),n&&e(Ht),n&&e(on),D(Q)}}}function ie(b,r){return b.toString(r).toUpperCase()}function Ye(b){return[function(r=[],d=-2,l="",c=""){r.reverse(),c.length===0&&(c=d.toString());let w="",T="";for(let y=0;y<r.length;y++){let f=r[y];w=`${f} \\cdot (${c})^${y}`+(w.length>0?" + ":"")+w,typeof d!="object"&&(T=`${f} \\cdot (${Math.pow(d,y).toFixed(2)}`+(T.length>0?" + ":"")+T)}return T.length>1&&(T="= "+T),k`${w} ${T} ${l}`}]}class aa extends he{constructor(r){super(),le(this,r,Ye,Xe,de,{})}}export{aa as default};
