...
<div class="box tc mx-a my20 p10 rx10">
    ...
    >
        ...
        <line
            ...
            stroke-width="1.2"
        />
        <text x={PM + 4} y={Y(1) - 4} fill="#c75200">
        ...
        {/each}
        <line x1={PM} x2={PM} y1={Y(YMAX)} y2={Y(ymin)} stroke="#999" />
        <line x1={PM} x2={PM + PW} y1={Y(ymin)} y2={Y(ymin)} stroke="#999" />
        <text x={PM + PW} y={Y(ymin) + 14} text-anchor="end" fill="#777">
            step {steps}
        </text>
        <polyline
            points={rawPts}
